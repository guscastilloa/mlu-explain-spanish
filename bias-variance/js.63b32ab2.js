parcelRequire = function(e, r, t, n) {
    ...
    "nCmd": [function(require, module, exports) {
        var define;
        var global = arguments[3];
        var e, t = arguments[3];
        ! function(t, n) {
            "object" == typeof exports && "undefined" != typeof module ? module.exports = n() : "function" == typeof e && e.amd ? e(n) : t.scrollama = n()
        }(this, function() {
            "use strict";
            ...
            function t(t) {
                ! function(t) {
                    ...
                    i.id = e(n), i.className = "scrollama__debug-offset", i.style.position = "fixed", i.style.left = "0", i.style.width = "100%", i.style.height = "0", i.style.borderTop = "2px dashed black", i.style.zIndex = "9999";
                    var s = document.createElement("p");
                    s.innerHTML = '".' + r + '" trigger: <span>' + o + "</span>", s.style.fontSize = "12px", s.style.fontFamily = "monospace", s.style.color = "black", s.style.margin = "0", s.style.padding = "6px", i.appendChild(s), document.body.appendChild(i)
                }({
                    id: t.id,
                    offsetVal: t.offsetVal,
                    stepClass: t.stepEl[0].className
                })
            }
            ...
            return function() {
                var o = ["stepAbove", "stepBelow", "stepProgress", "viewportAbove", "viewportBelow"],
                    r = {},
                    i = {},
                    s = null,
                    a = [],
                ...
                function H() {
                    window.pageYOffset > g ? M = "down" : window.pageYOffset < g && (M = "up"), g = window.pageYOffset
                }
                ...
                function _() {
                    var t, n;
                    d = window.innerHeight, t = document.body, n = document.documentElement, v = Math.max(t.scrollHeight, t.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight), p = u * ("pixels" === I ? 1 : d), x && (c = a.map(function(e) {
                        return e.getBoundingClientRect().height
                    }), l = a.map(S), b && D()), w && function(t) {
                        var n = t.id,
                            o = t.offsetMargin,
                            r = t.offsetVal,
                        ...
                        a.style.top = o + "px", a.querySelector("span").innerText = "" + r + i
                    }({
                        id: s,
                        offsetMargin: p,
                        offsetVal: u,
                ...
                function N(e) {
                    if (e && !b) {
                        if (!x) return C("scrollama error: enable() called before scroller was ready"), void(b = !1);
                        D()
                    }!e && b && o.forEach(k), b = e
                }
                ...
                function P(e, t) {
                    var n = B(e);
                    void 0 !== t && (f[n].progress = t);
                    var o = {
                        element: e,
                        index: n,
                        progress: f[n].progress
                    };
                    "enter" === f[n].state && r.stepProgress(o)
                }
                ...
                function R(e, t) {
                    if ("above" === t)
                        for (var n = 0; n < e; n += 1) {
                            var o = f[n];
                            "enter" !== o.state && "down" !== o.direction ? (T(a[n], "down", !1), q(a[n], "down")) : "enter" === o.state && q(a[n], "down")
                        } else if ("below" === t)
                            for (var r = f.length - 1; r > e; r -= 1) {
                                var i = f[r];
                                "enter" === i.state && q(a[r], "up"), "down" === i.direction && (T(a[r], "up", !1), q(a[r], "up"))
                            }
                }
                ...
                function T(e, t, o) {
                    ...
                    f[i].direction = t, f[i].state = "enter", y && o && "down" === t && R(i, "above"), y && o && "up" === t && R(i, "below"), r.stepEnter && !A[i] && (r.stepEnter(a, f), w && n({
                        id: s,
                        index: i,
                        state: "enter"
                    }), E && (A[i] = !0)), h && P(e)
                ...
                function q(e, t) {
                    ...
                    h && ("down" === t && f[o].progress < 1 ? P(e, 1) : "up" === t && f[o].progress > 0 && P(e, 0)), f[o].direction = t, f[o].state = "exit", r.stepExit(i, f), w && n({
                        id: s,
                        index: o,
                        state: "exit"
                    })
                ...
                function V(e) {
                    ...
                    var n = t.isIntersecting,
                        ...
                        l = B(r),
                        u = f[l];
                    n && a <= 0 && c >= 0 && "down" === M && "enter" !== u.state && T(r, M), !n && a > 0 && "up" === M && "enter" === u.state && q(r, M)
                }
                ...
                function Y(e) {
                    ...
                    var n = t.isIntersecting,
                        ...
                        l = B(r),
                        u = f[l];
                    n && a <= 0 && c >= 0 && "up" === M && "enter" !== u.state && T(r, M), !n && c < 0 && "down" === M && "enter" === u.state && q(r, M)
                }
                ...
                function F(e) {
                    ...
                    var n = t.isIntersecting,
                        ...
                        r = B(o),
                        i = f[r];
                    n && "down" === M && "down" !== i.direction && "enter" !== i.state && (T(o, "down"), q(o, "down"))
                }
                ...
                function j(e) {
                    ...
                    var n = t.isIntersecting,
                        ...
                        r = B(o),
                        i = f[r];
                    n && "up" === M && "down" === i.direction && "enter" !== i.state && (T(o, "up"), q(o, "up"))
                }
                ...
                function L() {
                    i.stepProgress = a.map(function(e, t) {
                        var n = c[t] - p + "px 0px " + (-d + p) + "px 0px",
                            o = function(e) {
                                for (var t = Math.ceil(e / m), n = [], o = 1 / t, r = 0; r < t; r += 1) n.push(r * o);
                                return n
                            }(c[t]),
                ...
                function D() {
                    o.forEach(k), i.viewportAbove = a.map(function(e, t) {
                        var n = v - l[t],
                            o = p - d - c[t],
                ...
                return J.setup = function(e) {
                    ...
                    void 0 === p && (p = !0);
                    var d, v, g, b = e.once;
                    if (void 0 === b && (b = !1), O(), v = (d = "abcdefghijklmnopqrstuv").length, g = Date.now(), s = "" + [0, 0, 0].map(function(e) {
                            return d[Math.floor(Math.random() * v)]
                        }).join("") + g, !(a = function(e, t) {
                            return void 0 === t && (t = document), "string" == typeof e ? Array.from(t.querySelectorAll(e)) : e instanceof Element ? [e] : e instanceof NodeList ? Array.from(e) : e instanceof Array ? e : []
                        }(n, o)).length) return C("no step elements"), J;
                    var M = a.reduce(function(e, t) {
                        return e || G(t.parentNode)
                    }, !1);
                    return M && console.error("scrollama error: step elements cannot be children of a scrollable element. Remove any css on the parent element with overflow: scroll; or overflow: auto; on elements with fixed height.", M), w = l, h = i, y = p, E = b, J.offsetTrigger(r), m = Math.max(1, +c), x = !0, w && t({
                        id: s,
                        stepEl: a,
                        offsetVal: u
                    ...
                    if (null === e) return u;
                    if ("number" == typeof e) I = "percent", e > 1 && C("offset value is greater than 1. Fallback to 1."), e < 0 && C("offset value is lower than 0. Fallback to 0."), u = Math.min(Math.max(0, e), 1);
                    else if ("string" == typeof e && e.indexOf("px") > 0) {
                        var t = +e.replace("px", "");
                        isNaN(t) ? (C("offset value must be in 'px' format. Fallback to 0.5."), u = .5) : (I = "pixels", u = t)
                    } else C("offset value does not include 'px'. Fallback to 0.5."), u = .5;
                    return J
                }, J.onStepEnter = function(e) {
                    return "function" == typeof e ? r.stepEnter = e : C("onStepEnter requires a function"), J
                }, J.onStepExit = function(e) {
                    return "function" == typeof e ? r.stepExit = e : C("onStepExit requires a function"), J
                }, J.onStepProgress = function(e) {
                    return "function" == typeof e ? r.stepProgress = e : C("onStepProgress requires a function"), J
                }, J
            }
        });
    }, {}],
    ...
    "LRy5": [function(require, module, exports) {
        ...
        function _(r) {
            ...
            for (var _ = this._groups, a = _.length, n = new Array(a), u = 0; u < a; ++u)
                for (var o, s, i = _[u], l = i.length, d = n[u] = new Array(l), f = 0; f < l; ++f)(o = i[f]) && (s = r.call(o, o.__data__, f, i)) && ("__data__" in o && (s.__data__ = o.__data__), d[f] = s);
    ...
    "ijGs": [function(require, module, exports) {
        ...
        function l(r) {
            ...
            for (var u = this._groups, l = u.length, o = [], a = [], s = 0; s < l; ++s)
                for (var i, f = u[s], c = f.length, d = 0; d < c; ++d)(i = f[d]) && (o.push(r.call(i, i.__data__, d, f)), a.push(i));
    ...
    "PkZe": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.childMatcher = e, exports.default = t;
    }, {}],
    "o9VE": [function(require, module, exports) {
        ...
        function i(e) {
            return this.select(null == e ? n : r("function" == typeof e ? e : (0, t.childMatcher)(e)))
        }
    }, {
        "../matcher.js": "PkZe"
    }],
    "VY5c": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = i;
        ...
        function i(t) {
            return this.selectAll(null == t ? r : n("function" == typeof t ? t : (0, e.childMatcher)(t)))
        }
    }, {
        "../matcher.js": "PkZe"
    }],
    "hrVj": [function(require, module, exports) {
        ...
        function n(t) {
            ...
            for (var n = this._groups, u = n.length, a = new Array(u), o = 0; o < u; ++o)
                for (var s, i = n[o], l = i.length, f = a[o] = [], _ = 0; _ < l; ++_)(s = i[_]) && t.call(s, s.__data__, _, i) && f.push(s);
    ...
    "wXei": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.EnterNode = s, exports.default = n;
    ...
    "QmPF": [function(require, module, exports) {
        ...
        function _(e, t, n, a, _, o) {
            for (var l, u = 0, f = t.length, i = o.length; u < i; ++u)(l = t[u]) ? (l.__data__ = o[u], a[u] = l) : n[u] = new r.EnterNode(e, o[u]);
        ...
        function o(e, t, n, a, _, o, l) {
            var u, f, i, s = new Map,
                ...
                c = o.length,
                h = new Array(d);
            for (u = 0; u < d; ++u)(f = t[u]) && (h[u] = i = l.call(f, f.__data__, u, t) + "", s.has(i) ? _[u] = f : s.set(i, f));
            for (u = 0; u < c; ++u) i = l.call(e, o[u], u, o) + "", (f = s.get(i)) ? (a[u] = f, f.__data__ = o[u], s.delete(i)) : n[u] = new r.EnterNode(e, o[u]);
        ...
        function u(r, a) {
            ...
            for (var s = i.length, d = new Array(s), c = new Array(s), h = new Array(s), g = 0; g < s; ++g) {
                var w = f[g],
                    y = i[g],
                    v = y.length,
    ...
    "i5nV": [function(require, module, exports) {
        ...
        function r(r) {
            ...
            for (var t = this._groups, n = r._groups, o = t.length, i = n.length, s = Math.min(o, i), a = new Array(o), l = 0; l < s; ++l)
                for (var u, f = t[l], h = n[l], c = f.length, g = a[l] = new Array(c), p = 0; p < c; ++p)(u = f[p] || h[p]) && (g[p] = u);
            for (; l < o; ++l) a[l] = t[l];
            return new e.Selection(a, this._parents)
        }
    }, {
    ...
    "D8yW": [function(require, module, exports) {
        ...
        function e(e) {
            ...
            for (var a = this._groups, o = a.length, u = new Array(o), _ = 0; _ < o; ++_) {
                for (var s, i = a[_], d = i.length, f = u[_] = new Array(d), c = 0; c < d; ++c)(s = i[c]) && (f[c] = s);
                f.sort(n)
            }
    ...
    "Tdf9": [function(require, module, exports) {
        ...
        function l(e, l) {
            ...
            return this.each((null == l ? s.local ? u : n : "function" == typeof l ? s.local ? c : o : s.local ? i : r)(s, l))
        }
    }, {
        "../namespace.js": "OLJ5"
    }],
    ...
    "j4rF": [function(require, module, exports) {
        ...
        function n(e) {
            return function() {
                var t = this.__on;
                if (t) {
                    for (var n, i = 0, r = -1, o = t.length; i < o; ++i) n = t[i], e.type && n.type !== e.type || n.name !== e.name ? t[++r] = n : this.removeEventListener(n.type, n.listener, n.options);
            ...
            return function() {
                ...
                if (o)
                    for (var a = 0, u = o.length; a < u; ++a)
                        if ((r = o[a]).type === t.type && r.name === t.name) return this.removeEventListener(r.type, r.listener, r.options), this.addEventListener(r.type, r.listener = s, r.options = i), void(r.value = n);
                this.addEventListener(t.type, s, i), r = {
                    type: t.type,
                    name: t.name,
                    value: n,
                    listener: s,
        ...
        function r(e, r, o) {
            ...
            if (f)
                for (var l, h = 0, v = f.length; h < v; ++h)
                    for (s = 0, l = f[h]; s < p; ++s)
                        if ((a = u[s]).type === l.type && a.name === l.name) return l.value
        }
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = r;
    ...
    "rmGH": [function(require, module, exports) {
        "use strict";

        function* e() {
            for (var e = this._groups, t = 0, r = e.length; t < r; ++t)
                for (var o, s = e[t], l = 0, u = s.length; l < u; ++l)(o = s[l]) && (yield o)
        }
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = e;
    ...
    "jpDG": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Selection = F, exports.root = exports.default = void 0;
        ...
        exports.root = D, F.prototype = G.prototype = {
            constructor: F,
            select: e.default,
            selectAll: r.default,
    ...
    "SNxp": [function(require, module, exports) {
        ...
        function r(t, r) {
            if (t = (0, e.default)(t), void 0 === r && (r = t.currentTarget), r) {
                var n = r.ownerSVGElement || r;
                if (n.createSVGPoint) {
                    var i = n.createSVGPoint();
                    return i.x = t.clientX, i.y = t.clientY, [(i = i.matrixTransform(r.getScreenCTM().inverse())).x, i.y]
                }
    ...
    "mxYx": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = u;
        ...
        function u(t, u) {
            return t.target && (t = (0, r.default)(t), void 0 === u && (u = t.currentTarget), t = t.touches || [t]), Array.from(t, r => (0, e.default)(r, u))
        }
    }, {
        "./pointer.js": "SNxp",
        "./sourceEvent.js": "mu9P"
    ...
    "toE0": [function(require, module, exports) {
        ...
        function n(r) {
            return "string" == typeof r ? new t.Selection([document.querySelectorAll(r)], [document.documentElement]) : new t.Selection([null == r ? [] : (0, e.default)(r)], t.root)
        }
    }, {
        "./array.js": "TVIB",
        "./selection/index.js": "jpDG"
    ...
    "J1vf": [function(require, module, exports) {
        "use strict";
    ...
    "Qz6O": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.axisBottom = x, exports.axisLeft = g, exports.axisRight = h, exports.axisTop = p;
        ...
        function m(e, m) {
            var p = [],
                ...
                k = 6,
                y = 3,
                _ = "undefined" != typeof window && window.devicePixelRatio > 1 ? 0 : .5,
                M = e === r || e === o ? -1 : 1,
                v = e === o || e === i ? "x" : "y",
                w = e === r || e === a ? l : c;
            ...
            function F(t) {
                var l = null == h ? m.ticks ? m.ticks.apply(m, p) : m.domain() : h,
                    ...
                    q = C.select("line"),
                    O = C.select("text");
                j = j.merge(j.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), C = C.merge(S), q = q.merge(S.append("line").attr("stroke", "currentColor").attr(v + "2", M * g)), O = O.merge(S.append("text").attr("fill", "currentColor").attr(v, M * F).attr("dy", e === r ? "0em" : e === a ? "0.71em" : "0.32em")), t !== H && (j = j.transition(t), C = C.transition(t), q = q.transition(t), O = O.transition(t), P = P.transition(t).attr("opacity", u).attr("transform", function(t) {
                    return isFinite(t = A(t)) ? w(t + _) : this.getAttribute("transform")
                }), S.attr("opacity", u).attr("transform", function(t) {
                    var n = this.parentNode.__axis;
                    return w((n && isFinite(n = n(t)) ? n : A(t)) + _)
                })), P.remove(), j.attr("d", e === o || e === i ? k ? "M" + M * k + "," + b + "H" + _ + "V" + z + "H" + M * k : "M" + _ + "," + b + "V" + z : k ? "M" + b + "," + M * k + "V" + _ + "H" + z + "V" + M * k : "M" + b + "," + _ + "H" + z), C.attr("opacity", 1).attr("transform", function(t) {
                    return w(A(t) + _)
                }), q.attr(v + "2", M * g), O.attr(v, M * F).text(c), H.filter(d).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", e === i ? "start" : e === o ? "end" : "middle"), H.each(function() {
                    this.__axis = A
                })
            }
    ...
    "raOJ": [function(require, module, exports) {
        ...
        function t(n) {
            ...
            return 1 === n.length && (e = ((e, t) => n(e) - t), t = u(n)), {
                left: l,
    ...
    "nH3P": [function(require, module, exports) {
        "use strict";
    ...
    "G2JF": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Adder = void 0, exports.fcumsum = r, exports.fsum = e;
        class t {
            constructor() {
            ...
            valueOf() {
                ...
                let e, r, s, o = this._n,
                    a = 0;
                if (o > 0) {
                    for (a = t[--o]; o > 0 && (e = a, !(s = (r = t[--o]) - ((a = e + r) - e))););
                    o > 0 && (s < 0 && t[o - 1] < 0 || s > 0 && t[o - 1] > 0) && (r = 2 * s) == (e = a + r) - a && (a = e)
                }
                return a
            }
        }
        ...
        function r(e, r) {
            const s = new t;
            let o = -1;
            return Float64Array.from(e, void 0 === r ? t => s.add(+t || 0) : t => s.add(+r(t, ++o, e) || 0))
        }
        exports.Adder = t;
    }, {}],
    ...
    "Q7X8": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = n, exports.groups = u, exports.index = i, exports.indexes = s, exports.rollup = o, exports.rollups = f;
    ...
    "s5J4": [function(require, module, exports) {
        ...
        function o(r, ...o) {
            if ("function" != typeof r[Symbol.iterator]) throw new TypeError("values is not iterable");
            r = Array.from(r);
            let [n = e.default] = o;
            if (1 === n.length || o.length > 1) {
                const u = Uint32Array.from(r, (e, t) => t);
                return o.length > 1 ? (o = o.map(e => r.map(e)), u.sort((t, r) => {
                    for (const n of o) {
                        const o = (0, e.default)(n[t], n[r]);
                        if (o) return o
                    }
                })) : (n = r.map(n), u.sort((t, r) => (0, e.default)(n[t], n[r]))), (0, t.default)(r, u)
            }
            return r.sort(n)
        }
    }, {
    ...
    "AzTm": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = o;
        ...
        function o(u, n, f) {
            return (1 === n.length ? (0, r.default)((0, t.rollup)(u, n, f), ([t, r], [u, n]) => (0, e.default)(r, n) || (0, e.default)(t, u)) : (0, r.default)((0, t.default)(u, f), ([t, r], [u, f]) => n(r, f) || (0, e.default)(t, u))).map(([e]) => e)
        }
    }, {
        "./ascending.js": "A6FA",
        "./group.js": "Q7X8",
    ...
    "nJNY": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = e, exports.tickIncrement = o, exports.tickStep = n;
        var t = Math.sqrt(50),
            r = Math.sqrt(10),
            a = Math.sqrt(2);
        ...
        function e(t, r, a) {
            ...
            if ((e = r < t) && (n = t, t = r, r = n), 0 === (h = o(t, r, a)) || !isFinite(h)) return [];
            if (h > 0) {
                let a = Math.round(t / h),
                    e = Math.round(r / h);
                for (a * h < t && ++a, e * h > r && --e, M = new Array(n = e - a + 1); ++u < n;) M[u] = (a + u) * h
            } else {
                h = -h;
                let a = Math.round(t * h),
                    e = Math.round(r * h);
        ...
        function o(e, o, n) {
            var M = (o - e) / Math.max(0, n),
                ...
                u = M / Math.pow(10, h);
            return h >= 0 ? (u >= t ? 10 : u >= r ? 5 : u >= a ? 2 : 1) * Math.pow(10, h) : -Math.pow(10, -h) / (u >= t ? 10 : u >= r ? 5 : u >= a ? 2 : 1)
        }
        ...
        function n(e, o, n) {
            var M = Math.abs(o - e) / Math.max(0, n),
                ...
                u = M / h;
            return u >= t ? h *= 10 : u >= r ? h *= 5 : u >= a && (h *= 2), o < e ? -h : h
        }
    }, {}],
    "lM1L": [function(require, module, exports) {
        ...
        function t(t, r, i) {
            ...
            for (;;) {
                ...
                c > 0 ? (t = Math.floor(t / c) * c, r = Math.ceil(r / c) * c) : c < 0 && (t = Math.ceil(t * c) / c, r = Math.floor(r * c) / c), o = c
            }
        }
    }, {
        "./ticks.js": "nJNY"
    ...
    "oEJX": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = c;
        ...
        function c() {
            ...
            function c(e) {
                ...
                if (!Array.isArray(h)) {
                    const e = y,
                        r = +h;
                    if (l === n.default && ([p, y] = (0, f.default)(p, y, r)), (h = (0, a.default)(p, y, r))[h.length - 1] >= y)
                        if (e >= y && l === n.default) {
                ...
                for (; h[j - 1] > y;) h.pop(), --j;
                var v, g = new Array(j + 1);
                for (t = 0; t <= j; ++t)(v = g[t] = []).x0 = t > 0 ? h[t - 1] : p, v.x1 = t < j ? h[t] : y;
                for (t = 0; t < i; ++t) p <= (u = c[t]) && u <= y && g[(0, r.default)(h, u, 0, j)].push(e[t]);
                return g
            }
    ...
    "Dxtw": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = o;
    ...
    "Z0Nc": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0, exports.shuffler = t;
        var e = t(Math.random);
    ...
    "Xx7f": [function(require, module, exports) {
        "use strict";
    ...
    "ngd6": [function(require, module, exports) {
        ...
        function e(e, r) {
            ...
            if ("function" != typeof r) throw new TypeError("mapper is not a function");
    ...
    "HNKz": [function(require, module, exports) {
        "use strict";
    ...
    "zgii": [function(require, module, exports) {
        "use strict";

        function e(e, ...t) {
            e = new Set(e);
            for (const o of t)
                for (const t of o) e.delete(t);
            return e
        }
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "mxnn": [function(require, module, exports) {
        "use strict";
    ...
    "fxdO": [function(require, module, exports) {
        "use strict";

        function e(...e) {
            const t = new Set;
            for (const o of e)
                for (const e of o) t.add(e);
            return t
        }
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "aZlr": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.initInterpolator = e, exports.initRange = t;
    }, {}],
    ...
    "UAf0": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Color = n, exports.Rgb = O, exports.darker = exports.brighter = void 0, exports.default = k, exports.hsl = $, exports.hslConvert = P, exports.rgb = N, exports.rgbConvert = M;
    ...
    "n21X": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Hcl = O, exports.Lab = w, exports.default = y, exports.gray = b, exports.hcl = x, exports.lch = N;
    ...
    "aDX2": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Cubehelix = b, exports.default = d;
        var t = i(require("./define.js")),
            e = require("./color.js"),
            r = require("./math.js");
        ...
        function b(t, e, r, n) {
            ...
            rgb: function() {
                var t = isNaN(this.h) ? 0 : (this.h + 120) * r.radians,
                    ...
                    c = Math.cos(t),
                    f = Math.sin(t);
                return new e.Rgb(255 * (n + i * (a * c + s * f)), 255 * (n + i * (o * c + u * f)), 255 * (n + i * (h * c)), this.opacity)
            }
        }));
    }, {
        "./define.js": "CSb3",
    ...
    "YtnT": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "OW9X": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = a, exports.gamma = o, exports.hue = u;
        ...
        function s(e) {
            return function(t) {
                var n, o, a = t.length,
                    ...
                    i = new Array(a),
                    s = new Array(a);
                for (n = 0; n < a; ++n) o = (0, r.rgb)(t[n]), u[n] = o.r || 0, i[n] = o.g || 0, s[n] = o.b || 0;
                return u = e(u), i = e(i), s = e(s), o.opacity = 1,
                    function(r) {
    ...
    "j6Kl": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = o, exports.genericArray = a;
        ...
        function n(e, r) {
            ...
            for (var a in e)
                if ("default" !== a && Object.prototype.hasOwnProperty.call(e, a)) {
                    ...
                    f && (f.get || f.set) ? Object.defineProperty(u, a, f) : u[a] = e[a]
    ...
    "ONGM": [function(require, module, exports) {
        ...
        function d(l, s) {
            var c, d = typeof s;
            return null == s || "boolean" === d ? (0, f.default)(s) : ("number" === d ? n.default : "string" === d ? (c = (0, e.color)(s)) ? (s = c, r.default) : o.default : s instanceof e.color ? r.default : s instanceof Date ? u.default : (0, i.isNumberArray)(s) ? i.default : Array.isArray(s) ? t.genericArray : "function" != typeof s.valueOf && "function" != typeof s.toString || isNaN(s) ? a.default : n.default)(l, s)
        }
    }, {
        "d3-color": "TJ2K",
        "./rgb.js": "hw5o",
    ...
    "igaz": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.parseCss = o, exports.parseSvg = i;
        var e, t = n(require("./decompose.js"));
        ...
        function o(e) {
            const r = new("function" == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(e + "");
            return r.isIdentity ? t.identity : (0, t.default)(r.a, r.b, r.c, r.d, r.e, r.f)
        }

        function i(r) {
            return null == r ? t.identity : (e || (e = document.createElementNS("http://www.w3.org/2000/svg", "g")), e.setAttribute("transform", r), (r = e.transform.baseVal.consolidate()) ? (r = r.matrix, (0, t.default)(r.a, r.b, r.c, r.d, r.e, r.f)) : t.identity)
        }
    }, {
        "./decompose.js": "sFbg"
    }],
        ...
        var a = function a(u, o, h) {
            function M(a, M) {
                var i, f, c = a[0],
                    ...
                    g = v - s,
                    q = d * d + g * g;
                if (q < t) f = Math.log(x / l) / u, i = function(t) {
    ...
    "BrWg": [function(require, module, exports) {
        ...
        function n(e, t) {
            ...
            for (var a in e)
                if ("default" !== a && Object.prototype.hasOwnProperty.call(e, a)) {
                    ...
                    f && (f.get || f.set) ? Object.defineProperty(o, a, f) : o[a] = e[a]
                } return o.default = e, n && n.set(e, o), o
        }
        ...
        function o(r) {
            return function(n, o) {
                ...
                return function(e) {
                    return n.h = u(e), n.s = a(e), n.l = f(e), n.opacity = l(e), n + ""
                }
            }
        }
        var u = o(t.hue);
    ...
    "VIlX": [function(require, module, exports) {
        ...
        function o(r) {
            return function(n, o) {
                ...
                return function(e) {
                    return n.h = u(e), n.c = a(e), n.l = c(e), n.opacity = f(e), n + ""
                }
            }
        }
        var u = o(t.hue);
    ...
    "NOHm": [function(require, module, exports) {
        ...
        function u(r) {
            return function n(u) {
                function o(n, o) {
                    var a = r((n = (0, e.cubehelix)(n)).h, (o = (0, e.cubehelix)(o)).h),
                        i = (0, t.default)(n.s, o.s),
                        f = (0, t.default)(n.l, o.l),
                        c = (0, t.default)(n.opacity, o.opacity);
                    return function(e) {
                        return n.h = a(e), n.s = i(e), n.l = f(Math.pow(e, u)), n.opacity = c(e), n + ""
                    }
                }
    ...
    "nlPb": [function(require, module, exports) {
        ...
        function t(r, t) {
            ...
            for (var u = 0, a = t.length - 1, n = t[0], o = new Array(a < 0 ? 0 : a); u < a;) o[u] = r(n, n = t[++u]);
            return function(e) {
    ...
    "ZpMB": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.copy = s, exports.default = m, exports.identity = i, exports.transformer = p;
        var n = require("d3-array"),
        ...
        function p() {
            ...
            function v() {
                ...
                return h !== i && (h = c(m[0], m[n - 1])), a = n > 2 ? f : l, s = p = null, y
            }

            function y(r) {
                return null == r || isNaN(r = +r) ? u : (s || (s = a(m.map(n), d, g)))(n(h(r)))
            }
    ...
    "cJhM": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = e, exports.formatDecimalParts = t;
    }, {}],
    ...
    "gePe": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.FormatSpecifier = o, exports.default = t;
        var i = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
    ...
    "KTGF": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = t, exports.prefixExponent = void 0;
        ...
        function t(t, a) {
            ...
            var i = o[0],
                n = o[1],
                s = n - (exports.prefixExponent = e = 3 * Math.max(-8, Math.min(8, Math.floor(n / 3)))) + 1,
                x = i.length;
            return s === x ? i : s > x ? i + new Array(s - x + 1).join("0") : s > 0 ? i.slice(0, s) + "." + i.slice(s) : "0." + new Array(1 - s).join("0") + (0, r.formatDecimalParts)(t, Math.max(0, a + s - 1))[0]
        }
    ...
    "VMtl": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = f, exports.linearish = a;
        var e = require("d3-array"),
        ...
        function a(t) {
            ...
            return t.ticks = function(t) {
                ...
                var u, i, o = r(),
                    ...
                    l = o[f],
                    p = 10;
                for (l < c && (i = c, c = l, l = i, i = a, a = f, f = i); p-- > 0;) {
                    if ((i = (0, e.tickIncrement)(c, l, n)) === u) return o[a] = c, o[f] = l, r(o);
    ...
    "X3YW": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = g, exports.loggish = p;
    ...
    "Prec": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = o, exports.symlogish = i;
    ...
    "ysea": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = p, exports.powish = o, exports.sqrt = s;
    ...
    "fsZk": [function(require, module, exports) {
        ...
        function r() {
            ...
            function o() {
                ...
                for (a = new Array(r - 1); ++e < r;) a[e - 1] = (0, n.quantileSorted)(u, e / r);
                return l
            }
            ...
            return l.invertExtent = function(n) {
                var e = i.indexOf(n);
                return e < 0 ? [NaN, NaN] : [e > 0 ? a[e - 1] : u[0], e < a.length ? a[e] : u[u.length - 1]]
            }, l.domain = function(e) {
    ...
    "Z2cL": [function(require, module, exports) {
        ...
        function t() {
            ...
            return f.domain = function(n) {
                ...
                return arguments.length ? (a = (l = Array.from(n)).length - 1, s()) : l.slice()
    ...
    "bZMy": [function(require, module, exports) {
        ...
        var a = (0, e.default)(e => e.setHours(0, 0, 0, 0), (e, t) => e.setDate(e.getDate() + t), (e, r) => (r - e - (r.getTimezoneOffset() - e.getTimezoneOffset()) * t.durationMinute) / t.durationDay, e => e.getDate() - 1),
            s = a;
        exports.default = s;
        var u = a.range;
        exports.days = u;
    ...
    "SWkQ": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        ...
        function y(i, n, o, a, d, s) {
            ...
            function l(u, n, o) {
                ...
                if (d === c.length) return i.every((0, e.tickStep)(u / t.durationYear, n / t.durationYear, o));
                if (0 === d) return r.default.every(Math.max((0, e.tickStep)(u, n, o), 1));
        ...
        const [M, v] = y(k.default, q.default, j.utcSunday, f.default, l.default, c.default);
        exports.utcTickInterval = v, exports.utcTicks = M;
        const [x, h] = y(s.default, d.default, a.sunday, o.default, n.default, i.default);
    ...
    "rf9h": [function(require, module, exports) {
            ...
            var i = u.dateTime,
                ...
                qn = {
                    a: function(n, t, e) {
                        ...
                        return r ? (n.w = Sn.get(r[0].toLowerCase()), e + r[0].length) : -1
                    },
                    A: function(n, t, e) {
                        var r = pn.exec(t.slice(e));
                        return r ? (n.w = Hn.get(r[0].toLowerCase()), e + r[0].length) : -1
                    },
                    b: function(n, t, e) {
                        var r = An.exec(t.slice(e));
                        return r ? (n.m = Vn.get(r[0].toLowerCase()), e + r[0].length) : -1
                    },
                    B: function(n, t, e) {
                        var r = Fn.exec(t.slice(e));
                        return r ? (n.m = Zn.get(r[0].toLowerCase()), e + r[0].length) : -1
                    },
                    c: function(n, t, e) {
                        return bn(n, i, t, e)
                    },
                    ...
                    p: function(n, t, e) {
                        ...
                        return r ? (n.p = Yn.get(r[0].toLowerCase()), e + r[0].length) : -1
                    },
                    q: U,
                    Q: Z,
                    s: A,
            ...
            function bn(n, t, e, r) {
                for (var u, i, o = 0, a = t.length, f = e.length; o < a;) {
                    ...
                    if (37 === (u = t.charCodeAt(o++))) {
                        if (u = t.charAt(o++), !(i = qn[u in c ? t.charAt(o++) : u]) || (r = i(n, e, r)) < 0) return -1
                    } else if (u != e.charCodeAt(r++)) return -1
                }
                return r
            }
            return Wn.x = Qn(o, Wn), Wn.X = Qn(a, Wn), Wn.c = Qn(i, Wn), jn.x = Qn(o, jn), jn.X = Qn(a, jn), jn.c = Qn(i, jn), {
                format: function(n) {
                    var t = Qn(n += "", Wn);
        ...
        function O(t) {
            var e = t.getDay();
            return e >= 4 || 0 === e ? (0, n.timeThursday)(t) : n.timeThursday.ceil(t)
        }

        function P(t, e) {
            return t = O(t), f(n.timeThursday.count((0, n.timeYear)(t), t) + (4 === (0, n.timeYear)(t).getDay()), e, 2)
        }
        ...
        function J(t, e) {
            var r = t.getDay();
            return f((t = r >= 4 || 0 === r ? (0, n.timeThursday)(t) : n.timeThursday.ceil(t)).getFullYear() % 1e4, e, 4)
        }
        ...
        function gn(t) {
            var e = t.getUTCDay();
            return e >= 4 || 0 === e ? (0, n.utcThursday)(t) : n.utcThursday.ceil(t)
        }

        function sn(t, e) {
            return t = gn(t), f(n.utcThursday.count((0, n.utcYear)(t), t) + (4 === (0, n.utcYear)(t).getUTCDay()), e, 2)
        }
        ...
        function Tn(t, e) {
            var r = t.getUTCDay();
            return f((t = r >= 4 || 0 === r ? (0, n.utcThursday)(t) : n.utcThursday.ceil(t)).getUTCFullYear() % 1e4, e, 4)
        }
    ...
    "QHrh": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.calendar = l, exports.default = p;
        ...
        function l(e, t, r, u, o, a, p, d, s, m) {
            ...
            function P(e) {
                return (s(e) < e ? w : d(e) < e ? g : p(e) < e ? D : a(e) < e ? M : u(e) < e ? o(e) < e ? O : b : r(e) < e ? k : h)(e)
            }
            return y.invert = function(e) {
                ...
                var n = j();
                return e && "function" == typeof e.range || (e = t(n[0], n[n.length - 1], null == e ? 10 : e)), e ? j((0, i.default)(n, e)) : y
            }, y.copy = function() {
        ...
        function p() {
            return r.initRange.apply(l(e.timeTicks, e.timeTickInterval, e.timeYear, e.timeMonth, e.timeWeek, e.timeDay, e.timeHour, e.timeMinute, e.timeSecond, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments)
        }
    }, {
        "d3-time": "F00f",
        "d3-time-format": "zs1a",
    ...
    "D6Mr": [function(require, module, exports) {
        ...
        function i() {
            return u.initRange.apply((0, r.calendar)(e.utcTicks, e.utcTickInterval, e.utcYear, e.utcMonth, e.utcWeek, e.utcDay, e.utcHour, e.utcMinute, e.utcSecond, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments)
        }
    }, {
        "d3-time": "F00f",
        "d3-time-format": "zs1a",
    ...
    "O1DZ": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.copy = l, exports.default = p, exports.sequentialLog = c, exports.sequentialPow = f, exports.sequentialSqrt = y, exports.sequentialSymlog = s;
        ...
        function a() {
            ...
            function s(n) {
                return null == n || isNaN(n = +n) ? u : p(0 === o ? .5 : (n = (i(n) - r) * o, c ? Math.max(0, Math.min(1, n)) : n))
            }

            function f(n) {
                return function(t) {
                    var r, e;
                    return arguments.length ? ([r, e] = t, p = n(r, e), s) : [p(0), p(1)]
                }
            }
            return s.domain = function(n) {
                    return arguments.length ? ([a, l] = n, r = i(a = +a), e = i(l = +l), o = r === e ? 0 : 1 / (e - r), s) : [a, l]
                }, s.clamp = function(n) {
                ...
                function(n) {
                    return i = n, r = n(a), e = n(l), o = r === e ? 0 : 1 / (e - r), s
                }
        }
    ...
    "Y40z": [function(require, module, exports) {
        ...
        function e() {
            ...
            function o(r) {
                if (null != r && !isNaN(r = +r)) return u(((0, n.bisect)(i, r, 1) - 1) / (i.length - 1))
            }
    ...
    "shE4": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = c, exports.divergingLog = l, exports.divergingPow = g, exports.divergingSqrt = f, exports.divergingSymlog = s;
        var n = require("d3-interpolate"),
            r = require("./continuous.js"),
            t = require("./init.js"),
            e = require("./linear.js"),
    ...
    "E5FC": [function(require, module, exports) {
        ...
        _.prototype = e.prototype = {
            ...
            bezierCurveTo: function(t, i, s, h, _, e) {
                this._ += "C" + +t + "," + +i + "," + +s + "," + +h + "," + (this._x1 = +_) + "," + (this._y1 = +e)
            },
            arcTo: function(i, s, h, _, e) {
                ...
                if (null === this._x1) this._ += "M" + (this._x1 = i) + "," + (this._y1 = s);
                else if (x > 1e-6)
                    if (Math.abs(c * r - a * u) > 1e-6 && e) {
                        var y = h - n,
                            ...
                            v = Math.sqrt(M),
                            d = Math.sqrt(x),
                            p = e * Math.tan((t - Math.acos((M + x - l) / (2 * v * d))) / 2),
                            b = p / d,
                            w = p / v;
                        Math.abs(b - 1) > 1e-6 && (this._ += "L" + (i + b * u) + "," + (s + b * c)), this._ += "A" + e + "," + e + ",0,0," + +(c * y > u * f) + "," + (this._x1 = i + w * r) + "," + (this._y1 = s + w * a)
            ...
            arc: function(s, _, e, n, o, r) {
                ...
                var a = (e = +e) * Math.cos(n),
                    ...
                    f = r ? n - o : o - n;
                if (e < 0) throw new Error("negative radius: " + e);
                null === this._x1 ? this._ += "M" + c + "," + x : (Math.abs(this._x1 - c) > 1e-6 || Math.abs(this._y1 - x) > 1e-6) && (this._ += "L" + c + "," + x), e && (f < 0 && (f = f % i + i), f > h ? this._ += "A" + e + "," + e + ",0,1," + y + "," + (s - a) + "," + (_ - u) + "A" + e + "," + e + ",0,1," + y + "," + (this._x1 = c) + "," + (this._y1 = x) : f > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(f >= t) + "," + y + "," + (this._x1 = s + e * Math.cos(o)) + "," + (this._y1 = _ + e * Math.sin(o))))
            },
    ...
    "R8vA": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.abs = void 0, exports.acos = h, exports.asin = M, exports.tau = exports.sqrt = exports.sin = exports.pi = exports.min = exports.max = exports.halfPi = exports.epsilon = exports.cos = exports.atan2 = void 0;
        var t = Math.abs;
        exports.abs = t;
        var r = Math.atan2;
        exports.atan2 = r;
    ...
    "brsM": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = r, exports.slice = void 0;
        var e = Array.prototype.slice;
    ...
    "UmeQ": [function(require, module, exports) {
        ...
        function f(l, f) {
            ...
            function d(t) {
                var u, r, d, p = (t = (0, n.default)(t)).length,
                    s = !1;
                for (null == i && (c = a(d = (0, e.path)())), u = 0; u <= p; ++u) !(u < p && o(r = t[u], u, t)) === s && ((s = !s) ? c.lineStart() : c.lineEnd()), s && c.point(+l(r, u, t), +f(r, u, t));
                if (d) return c = null, d + "" || null
            }
            return l = "function" == typeof l ? l : void 0 === l ? r.x : (0, t.default)(l), f = "function" == typeof f ? f : void 0 === f ? r.y : (0, t.default)(f), d.x = function(e) {
                return arguments.length ? (l = "function" == typeof e ? e : (0, t.default)(+e), d) : l
            }, d.y = function(e) {
                return arguments.length ? (f = "function" == typeof e ? e : (0, t.default)(+e), d) : f
            }, d.defined = function(e) {
                return arguments.length ? (o = "function" == typeof e ? e : (0, t.default)(!!e), d) : o
            }, d.curve = function(e) {
                return arguments.length ? (a = e, null != i && (c = a(i)), d) : a
            }, d.context = function(e) {
                return arguments.length ? (null == e ? i = c = null : c = a(i = e), d) : i
            }, d
        }
    }, {
        "d3-path": "dz42",
    ...
    "UWil": [function(require, module, exports) {
        ...
        function i(f, i, o) {
            ...
            function s(t) {
                var u, l, r, s, h, x = (t = (0, e.default)(t)).length,
                    g = !1,
                    v = new Array(x),
                    j = new Array(x);
                for (null == d && (p = y(h = (0, n.path)())), u = 0; u <= x; ++u) {
                    if (!(u < x && c(s = t[u], u, t)) === g)
                        if (g = !g) l = u, p.areaStart(), p.lineStart();
                        else {
                            for (p.lineEnd(), p.lineStart(), r = u - 1; r >= l; --r) p.point(v[r], j[r]);
                            p.lineEnd(), p.areaEnd()
                        } g && (v[u] = +f(s, u, t), j[u] = +i(s, u, t), p.point(a ? +a(s, u, t) : v[u], o ? +o(s, u, t) : j[u]))
                }
            ...
            return f = "function" == typeof f ? f : void 0 === f ? r.x : (0, t.default)(+f), i = "function" == typeof i ? i : void 0 === i ? (0, t.default)(0) : (0, t.default)(+i), o = "function" == typeof o ? o : void 0 === o ? r.y : (0, t.default)(+o), s.x = function(n) {
                return arguments.length ? (f = "function" == typeof n ? n : (0, t.default)(+n), a = null, s) : f
            }, s.x0 = function(n) {
                return arguments.length ? (f = "function" == typeof n ? n : (0, t.default)(+n), s) : f
            }, s.x1 = function(n) {
                return arguments.length ? (a = null == n ? null : "function" == typeof n ? n : (0, t.default)(+n), s) : a
            }, s.y = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : (0, t.default)(+n), o = null, s) : i
            }, s.y0 = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : (0, t.default)(+n), s) : i
            }, s.y1 = function(n) {
                return arguments.length ? (o = null == n ? null : "function" == typeof n ? n : (0, t.default)(+n), s) : o
                ...
                return arguments.length ? (c = "function" == typeof n ? n : (0, t.default)(!!n), s) : c
            }, s.curve = function(n) {
                return arguments.length ? (y = n, null != d && (p = y(d)), s) : y
            }, s.context = function(n) {
                return arguments.length ? (null == n ? d = p = null : p = y(d = n), s) : d
            }, s
        }
    }, {
        "d3-path": "dz42",
    ...
    "OJYo": [function(require, module, exports) {
        ...
        function a() {
            ...
            function s(e) {
                var n, u, s, c, h, p = (e = (0, t.default)(e)).length,
                    g = 0,
                    y = new Array(p),
                    A = new Array(p),
                    j = +i.apply(this, arguments),
                    v = Math.min(r.tau, Math.max(-r.tau, o.apply(this, arguments) - j)),
                    M = Math.min(Math.abs(v) / p, d.apply(this, arguments)),
                    q = M * (v < 0 ? -1 : 1);
                for (n = 0; n < p; ++n)(h = A[y[n] = n] = +l(e[n], n, e)) > 0 && (g += h);
                for (null != a ? y.sort(function(t, e) {
                        return a(A[t], A[e])
                    }) : null != f && y.sort(function(t, n) {
                        return f(e[t], e[n])
                    }), n = 0, s = g ? (v - p * q) / g : 0; n < p; ++n, j = c) u = y[n], c = j + ((h = A[u]) > 0 ? h * s : 0) + q, A[u] = {
                    data: e[u],
                    index: n,
                    value: h,
                    startAngle: j,
            ...
            return s.value = function(t) {
                return arguments.length ? (l = "function" == typeof t ? t : (0, e.default)(+t), s) : l
                ...
                return arguments.length ? (i = "function" == typeof t ? t : (0, e.default)(+t), s) : i
            }, s.endAngle = function(t) {
                return arguments.length ? (o = "function" == typeof t ? t : (0, e.default)(+t), s) : o
            }, s.padAngle = function(t) {
                return arguments.length ? (d = "function" == typeof t ? t : (0, e.default)(+t), s) : d
            }, s
        }
    }, {
        "./array.js": "brsM",
    ...
    "m9TD": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.curveRadialLinear = void 0, exports.default = i;
    ...
    "p8dR": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = i, exports.lineRadial = a;
        ...
        function u(e, r) {
            ...
            for (var i in e)
                if ("default" !== i && Object.prototype.hasOwnProperty.call(e, i)) {
                    ...
                    o && (o.get || o.set) ? Object.defineProperty(u, i, o) : u[i] = e[i]
                } return u.default = e, t && t.set(e, u), u
        }
    ...
    "CMsX": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.linkHorizontal = s, exports.linkRadial = y, exports.linkVertical = d;
        var e = require("d3-path"),
            t = require("../array.js"),
    ...
    "XBPQ": [function(require, module, exports) {
        ...
        var a = [t.default, u.default, r.default, n.default, l.default, o.default, s.default];
        ...
        function d(u, r) {
            ...
            function n() {
                var t;
                if (l || (l = t = (0, e.path)()), u.apply(this, arguments).draw(l, +r.apply(this, arguments)), t) return l = null, t + "" || null
            }
            return u = "function" == typeof u ? u : (0, f.default)(u || t.default), r = "function" == typeof r ? r : (0, f.default)(void 0 === r ? 64 : +r), n.type = function(e) {
                return arguments.length ? (u = "function" == typeof e ? e : (0, f.default)(e), n) : u
            }, n.size = function(e) {
                return arguments.length ? (r = "function" == typeof e ? e : (0, f.default)(+e), n) : r
    ...
    "XakR": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Basis = i, exports.default = s, exports.point = t, i.prototype = {
            areaStart: function() {
                this._line = 0
            },
            areaEnd: function() {
    ...
    "DbQK": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.bumpX = i, exports.bumpY = e;
        class t {
            constructor(t, i) {
    ...
    "fNTp": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Cardinal = i, exports.default = void 0, exports.point = t, i.prototype = {
            areaStart: function() {
                this._line = 0
            },
            areaEnd: function() {
    ...
    "oWDJ": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0, exports.point = i;
    ...
    "UYn4": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = i, exports.stepAfter = n, exports.stepBefore = e, t.prototype = {
            areaStart: function() {
                this._line = 0
            },
            areaEnd: function() {
    ...
    "S7q8": [function(require, module, exports) {
        ...
        function a() {
            ...
            function d(t) {
                var r, n, f = Array.from(u.apply(this, arguments), o),
                    d = f.length,
                    c = -1;
                for (const e of t)
                    for (r = 0, ++c; r < d; ++r)(f[r][c] = [0, +i(e, f[r].key, c, t)]).data = e;
                for (r = 0, n = (0, e.default)(a(f)); r < d; ++r) f[n[r]].index = r;
                return l(f, n), f
            }
            return d.keys = function(e) {
                return arguments.length ? (u = "function" == typeof e ? e : (0, t.default)(Array.from(e)), d) : u
            }, d.value = function(e) {
                return arguments.length ? (i = "function" == typeof e ? e : (0, t.default)(+e), d) : i
            }, d.order = function(e) {
                return arguments.length ? (a = null == e ? n.default : "function" == typeof e ? e : (0, t.default)(Array.from(e)), d) : a
            }, d.offset = function(e) {
                return arguments.length ? (l = null == e ? r.default : e, d) : l
            }, d
        }
    }, {
        "./array.js": "brsM",
    ...
    "v2Ya": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Timer = m, exports.now = f, exports.timer = p, exports.timerFlush = w;
        var t, n, e = 0,
            o = 0,
            i = 0,
            r = 1e3,
    ...
    "iEU7": [function(require, module, exports) {
        ...
        function r(r, t, s) {
            var u = new e.Timer;
            return t = null == t ? 0 : +t, u.restart(e => {
                u.stop(), r(e + t)
            }, t, s), u
        }
    }, {
    ...
    "B8zX": [function(require, module, exports) {
        ...
        function t(t, e, s) {
            var n = new r.Timer,
                a = e;
            return null == e ? (n.restart(t, e, s), n) : (n._restart = n.restart, n.restart = function(t, e, s) {
                e = +e, s = null == s ? (0, r.now)() : +s, n._restart(function r(u) {
    ...
    "GDzO": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.STARTING = exports.STARTED = exports.SCHEDULED = exports.RUNNING = exports.ENDING = exports.ENDED = exports.CREATED = void 0, exports.default = p, exports.get = f, exports.init = _, exports.set = c;
    ...
    "odSN": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = r;
    ...
    "Xvwr": [function(require, module, exports) {
        ...
        function o(n) {
            ...
            for (var i = this._groups, u = i.length, f = new Array(u), s = 0; s < u; ++s)
                for (var _, l, c = i[s], p = c.length, d = f[s] = new Array(p), y = 0; y < p; ++y)(_ = c[y]) && (l = n.call(_, _.__data__, y, c)) && ("__data__" in _ && (l.__data__ = _.__data__), d[y] = l, (0, r.default)(d[y], a, o, y, d, (0, r.get)(_, o)));
    ...
    "DOdJ": [function(require, module, exports) {
        ...
        function u(n) {
            ...
            for (var i = this._groups, a = i.length, f = [], l = [], s = 0; s < a; ++s)
    ...
    "rWxz": [function(require, module, exports) {
        ...
        function a() {
            for (var r = this._name, n = this._id, a = (0, e.newId)(), i = this._groups, u = i.length, o = 0; o < u; ++o)
    ...
    "J3C7": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Transition = v, exports.default = g, exports.newId = b;
        var e = require("d3-selection"),
            t = T(require("./attr.js")),
    ...
    "GaS5": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.quadIn = t, exports.quadInOut = u, exports.quadOut = e;
    }, {}],
    "PA7e": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.cubicIn = t, exports.cubicInOut = u, exports.cubicOut = e;
    }, {}],
    ...
    "sZZb": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.sinIn = e, exports.sinInOut = s, exports.sinOut = r;
        var t = Math.PI,
            n = t / 2;
    ...
    "rYq8": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.expIn = e, exports.expInOut = n, exports.expOut = r;
        var t = require("./math.js");
        ...
        function n(e) {
            return ((e *= 2) <= 1 ? (0, t.tpmt)(1 - e) : 2 - (0, t.tpmt)(e - 1)) / 2
        }
    }, {
        "./math.js": "dlJR"
    }],
    "hED8": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.circleIn = t, exports.circleInOut = e, exports.circleOut = r;
    }, {}],
    "MKsh": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.bounceIn = b, exports.bounceInOut = x, exports.bounceOut = f;
        var e = 4 / 11,
            t = 6 / 11,
            n = 8 / 11,
            r = .75,
    ...
    "xolo": [function(require, module, exports) {
        ...
        var a = function r(e, i) {
            ...
            function a(n) {
                return ((n = 2 * n - 1) < 0 ? e * (0, t.tpmt)(-n) * Math.sin((u - n) / i) : 2 - e * (0, t.tpmt)(n) * Math.sin((u + n) / i)) / 2
            }
            return a.amplitude = function(t) {
                return r(t, i * n)
            }, a.period = function(t) {
    ...
    "CNir": [function(require, module, exports) {
        ...
        function a(n) {
            var i, a;
            n instanceof e.Transition ? (i = n._id, n = n._name) : (i = (0, e.newId)(), (a = o).time = (0, t.now)(), n = null == n ? null : n + "");
            for (var s = this._groups, d = s.length, l = 0; l < d; ++l)
                for (var f, _ = s[l], c = _.length, v = 0; v < c; ++v)(f = _[v]) && (0, r.default)(f, n, i, v, _, a || u(f, i));
    ...
    "MuPq": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.trainColorDot = exports.trainColorBar = exports.testColorDot = exports.testColorBar = exports.lineColor = void 0;
        var o = "#94CAE0";
        exports.trainColorDot = o;
        var r = "#E57873";
        exports.testColorDot = r;
        var t = r;
        exports.testColorBar = t;
        var e = o;
        exports.trainColorBar = e;
        var s = "green";
        exports.lineColor = s;
    }, {}],
    "iLwp": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.trainData = exports.testData = exports.modelsData = exports.errorData = exports.ddUShape = exports.ddTrainTest = void 0;
        var o = [{
            x: .005,
            y: .564,
            y_pred_uf: .424,
        ...
        exports.modelsData = p;
    }, {}],
    "Qe0t": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        ...
        var u = function() {
            function h(r) {
                l(this, h), this.element = r.element, this.chartDims = (0, t.select)("#scroll-figure").node().getBoundingClientRect(), console.log("chartDims", this.chartDims), this.MARGIN = window.innerWidth <= 700 ? {
                    TOP: 20,
                    BOTTOM: 30,
                    LEFT: 30,
                    RIGHT: 9
            ...
            return d(h, [{
                key: "drawErrorBase",
                value: function() {
                    this.xScaleError = (0, e.scaleLinear)().domain((0, o.extent)(s.errorData, function(t) {
                        return +t.x
                    })).range([0, this.WIDTH]), this.xAxisGroup.transition().style("opacity", 1).call((0, r.axisBottom)(this.xScaleError).tickSizeOuter(0).ticks(4)).selectAll("line.tick").style("opacity", .2), this.yScaleError = (0, e.scaleLinear)().domain([-.05, .8]).range([this.HEIGHT, 0]), this.yAxisGroup.transition().style("opacity", 1).call((0, r.axisLeft)(this.yScaleError).tickSizeOuter(0).ticks(4))
                }
            }, {
                key: "plotErrorLines",
                value: function(t, e) {
                    var n = this,
                        ...
                        l = "bias_".concat(e),
                        h = "var_".concat(e),
                        d = (0, a.transition)().delay(200).duration(1500);
                    "final" === e || "point" == e ? (this.yScaleError.domain([-.05, 1.3]), this.yAxisGroup.transition().style("opacity", 1).call((0, r.axisLeft)(this.yScaleError).tickSizeOuter(0).ticks(0))) : (this.yScaleError.domain([-.05, .8]), this.yAxisGroup.transition().style("opacity", 1).call((0, r.axisLeft)(this.yScaleError).tickSizeOuter(0).ticks(4)));
                    var u = (0, i.line)().x(function(r) {
                            return n.xScaleError(+r[t])
                        }).y(function(t) {
                            return n.yScaleError(+t[o])
                        }).curve(i.curveCatmullRom.alpha(.8)),
                        x = (0, i.line)().x(function(r) {
                            return n.xScaleError(+r[t])
                        }).y(function(t) {
                            return n.yScaleError(+t[c])
                        }).curve(i.curveCatmullRom.alpha(.8)),
                        y = (0, i.line)().x(function(r) {
                            return n.xScaleError(+r[t])
                        }).y(function(t) {
                            return n.yScaleError(+t[l])
                        }).curve(i.curveCatmullRom.alpha(.8)),
                        p = (0, i.line)().x(function(r) {
                            return n.xScaleError(+r[t])
                        }).y(function(t) {
                            return n.yScaleError(+t[h])
                        }).curve(i.curveCatmullRom.alpha(.8));
                    this.noiseLine = this.svg.selectAll("#noise-line").data([s.errorData], function(r) {
                        return +r[t]
                    }), this.noiseLine.enter().append("path").attr("id", "noise-line").merge(this.noiseLine).attr("class", "error-line-bottom").transition(d).attr("d", u), this.errorLine = this.svg.selectAll("#error-line").data([s.errorData], function(r) {
                        return +r[t]
                    }), this.errorLine.enter().append("path").attr("id", "error-line").merge(this.errorLine).attr("class", "error-line-bottom").transition(d).attr("d", x), this.biasLine = this.svg.selectAll("#bias-line").data([s.errorData], function(r) {
                        return +r[t]
                    }), this.biasLine.enter().append("path").attr("id", "bias-line").merge(this.biasLine).attr("class", "error-line-bottom").transition(d).attr("d", y), this.varLine = this.svg.selectAll("#var-line").data([s.errorData], function(r) {
                        return +r[t]
                    }), this.varLine.enter().append("path").attr("id", "var-line").merge(this.varLine).attr("class", "error-line-bottom").transition(d).attr("d", p)
                }
            }, {
                key: "plotComplexCircleOne",
                value: function() {
                    var t = this,
                        r = ["bias", "var", "noise", "error"].map(function(t) {
                            return {
                                x: s.errorData[0].x_point,
                                y: s.errorData[0]["".concat(t, "_point")],
                                name: t
                            }
                        });
                    this.svg.selectAll("circle.complexity").data(r).enter().append("circle").attr("class", "complexity").attr("class", function(t) {
                        return "complex-".concat(t.name)
                    }).style("stroke-width", 2).attr("stroke", "white").attr("cx", function(r) {
                        return t.xScaleError(+r.x)
                    }).attr("cy", function(r) {
                        return t.yScaleError(+r.y)
                    }).attr("r", 0).transition().delay(1300).attr("r", window.innerWidth <= 600 ? 9.5 : 12).transition().attr("r", window.innerWidth <= 600 ? 5 : 8)
                }
            }, {
                key: "plotComplexCircleAll",
                value: function() {
                    var t = this;
                    this.svg.selectAll("circle.complexity").data(s.errorData).enter().append("circle").attr("class", "complexity").attr("class", function(t) {
                        return "complex-noise"
                    }).style("stroke-width", 2).attr("stroke", "white").attr("cx", function(r) {
                        return t.xScaleError(+r.x)
                    }).attr("cy", function(r) {
                        return t.yScaleError(+r.noise_final)
                    }).attr("r", 0).transition().attr("r", window.innerWidth <= 600 ? 9.5 : 12).transition().attr("r", window.innerWidth <= 600 ? 5 : 8), this.svg.selectAll("circle.complexity").data(s.errorData).enter().append("circle").attr("class", "complexity").attr("class", function(t) {
                        return "complex-error"
                    }).style("stroke-width", 2).attr("stroke", "white").attr("cx", function(r) {
                        return t.xScaleError(+r.x)
                    }).attr("cy", function(r) {
                        return t.yScaleError(+r.error_final)
                    }).attr("r", 0).transition().attr("r", window.innerWidth <= 600 ? 9.5 : 12).transition().attr("r", window.innerWidth <= 600 ? 5 : 8), this.svg.selectAll("circle.complexity").data(s.errorData).enter().append("circle").attr("class", "complexity").attr("class", function(t) {
                        return "complex-bias"
                    }).style("stroke-width", 2).attr("stroke", "white").attr("cx", function(r) {
                        return t.xScaleError(+r.x)
                    }).attr("cy", function(r) {
                        return t.yScaleError(+r.bias_final)
                    }).attr("r", 0).transition().attr("r", window.innerWidth <= 600 ? 9.5 : 12).transition().attr("r", window.innerWidth <= 600 ? 5 : 8), this.svg.selectAll("circle.complexity").data(s.errorData).enter().append("circle").attr("class", "complexity").attr("class", function(t) {
                        return "complex-var"
                    }).style("stroke-width", 2).attr("stroke", "white").attr("cx", function(r) {
                        return t.xScaleError(+r.x)
                    }).attr("cy", function(r) {
                        return t.yScaleError(+r.var_final)
                    }).attr("r", 0).transition().attr("r", window.innerWidth <= 600 ? 9.5 : 12).transition().attr("r", window.innerWidth <= 600 ? 5 : 8)
                }
            }, {
                key: "plotReverseDecompositionBar",
                value: function() {
                    var t = (0, a.transition)().duration(600);
                    this.xScale.domain([0, .42]), this.xAxisGroup.transition(t).call((0, r.axisBottom)(this.xScale).tickSizeOuter(0)).style("opacity", 1), this.yAxisGroup.transition(t).style("opacity", 1)
                }
            }, {
                key: "plotDecompositionBar",
                value: function(i) {
                    var n = this,
                        s = this,
                        l = (0, a.transition)().delay(100).duration(600),
                    ...
                    this.decompLegend = this.svg.append("g").attr("class", "decomp-legend").attr("transform", "translate(0,0)"), this.decompGs = this.decompLegend.selectAll("g.decompG").data(this.decomp).enter().append("g").attr("class", "decompG");
                    this.decompGs.append("rect").attr("class", "stacked").attr("fill", function(t) {
                        return d(t.error)
                    }).attr("id", function(t) {
                        return "rect-".concat(t.error)
                    }).attr("x", function(t) {
                        return n.decompAxis(t.error)
                    }).attr("y", function(t) {
                        return n.yScale(t.name)
                    }).attr("height", this.yScale.bandwidth()).attr("width", function(t) {
                        return n.xScale(+t.value)
                    }).style("opacity", 0);
                    this.decompGs.append("text").attr("class", "decomp-text").attr("x", function(t) {
                        return n.decompAxis(t.error)
                    }).attr("y", function(t) {
                        return n.yScale.bandwidth() / 2 + n.MARGIN.TOP
                    }).attr("dx", function(t) {
                        return n.xScale(+t.value) / 2
                    }).text(function(t) {
                        return n.biasMap(t.error)
                    }).style("opacity", 0), this.textBox = {}, (0, t.selectAll)(".decomp-text").each(function(t) {
                        var r = this.getBBox();
                        s.textBox[t.error] = r
                    }), (0, t.selectAll)(".decomp-text").attr("text-anchor", "middle");
                    var u = (0, a.transition)().delay(600).ease(c.easeBack).duration(500);
                    (0, t.selectAll)("rect.stacked").transition(u).style("opacity", .7), (0, t.selectAll)(".decomp-text").transition(u).style("opacity", 1), this.rects.transition(u).style("opacity", 0)
                }
            }, {
                key: "reverseDecomposition",
                value: function() {
                    var t = this,
                        e = (0, a.transition)().delay(100).duration(600);
                    this.decompGs.selectAll("rect").transition(e).attr("x", function(r) {
                        return t.decompAxis(r.error)
                    }).attr("y", function(r) {
                        return t.yScale(r.name)
                    }).attr("height", this.yScale.bandwidth()).attr("width", function(r) {
                        return t.xScale(+r.value)
                    }), this.decompGs.selectAll("text").attr("x", function(r) {
                        return t.decompAxis(r.error)
                    }).attr("y", function(r) {
                ...
                key: "hideAxes",
                value: function() {
                    this.xAxisGroup.transition().style("opacity", 0), this.yAxisGroup.transition().style("opacity", 0)
                }
            }, {
                key: "positionErrorBarsAsLabels",
                value: function() {
                    var r = this,
                        e = this,
                    ...
                    this.yScale.domain(["Test"]), (0, t.selectAll)("rect.stacked").style("opacity", .7), (0, t.selectAll)(".decomp-text").style("opacity", 1), (0, t.selectAll)("rect.stacked").transition().attr("x", function(t) {
                        ...
                        return window.innerWidth <= 600 ? r.textBox[t.error].width + 1.5 * i : r.textBox[t.error].width + 2 * i
                    }).attr("height", function(t) {
                        return r.textBox[t.error].height + 2 * n
                    });
                    var o = 0;
                    this.decompGs.transition().duration(800).attr("transform", function(t) {
                        var r = o;
                        o += e.textBox[t.error].width + 2.5 * i + s;
                        var a = e.decompAxis(t.error) - 2 * i,
                            n = e.WIDTH / 10 - a;
                        n += r, n = window.innerWidth <= 600 ? n - e.MARGIN.LEFT / 2.5 : n;
                        var c = -(e.yScale.bandwidth() / 2 + e.MARGIN.TOP);
                        return "translate(".concat(n, ", ").concat(c, ")")
                    }).selectAll(".decomp-text").attr("text-anchor", "right"), this.decompLegend.attr("transform", function() {
                        return "translate(".concat((e.WIDTH - this.getBBox().width) / 2, ", 0)")
                    });
                    var c = this.decompLegend.append("text").attr("id", "error-text").attr("x", this.biasX).attr("y", this.MARGIN.TOP).text("Error").style("font-family", "AmazonEmberDisplayHeavy").style("opacity", 0),
                        l = {};
                    (0, t.select)("#error-text").each(function(t, r) {
                        var a = this.getBBox(),
                            s = a.width + 2 * i,
                            o = a.height + 2 * n;
                        l.x = e.biasX - s, l.width = s, l.height = o, l.y = a.y
                    }), c.transition().attr("x", window.innerWidth <= 600 ? l.x - i - e.MARGIN.LEFT / 2.5 : l.x - i).attr("y", 0);
                    var h = this.decompLegend.append("rect").attr("class", "stacked-error").attr("fill", "red").attr("x", window.innerWidth <= 600 ? l.x - 2 * i - e.MARGIN.LEFT / 2.5 : l.x - 2 * i).attr("y", l.y - n - e.MARGIN.TOP).attr("width", l.width).attr("height", l.height).lower().style("opacity", 0),
                        d = (this.decompLegend.append("text").attr("class", "error-symbol").attr("x", window.innerWidth <= 600 ? l.x + l.width - i - e.MARGIN.LEFT / 2.5 : l.x + l.width - i).attr("y", 0).text("=").style("font-family", "AmazonEmberDisplayHeavy").style("opacity", 0), this.decompGs.filter(function(t, r) {
                            return 0 !== r
                        }).append("text").attr("class", "error-symbol").attr("x", function(t) {
                            return r.textBox[t.error].x - i - s
                        }).attr("dx", window.innerWidth <= 600 ? -2 : 0).attr("y", e.yScale.bandwidth() / 2 + this.MARGIN.TOP).text("+").style("font-family", "AmazonEmberDisplayHeavy").style("opacity", 0), (0, a.transition)().delay(800));
                    c.transition(d).style("opacity", 1), (0, t.selectAll)(".error-symbol").transition(d).style("opacity", .9), h.transition(d).style("opacity", .7)
                }
            }, {
                key: "addTitle",
                value: function(r) {
                    (0, t.select)("#errorBarTitle").remove(), this.svg.append("text").attr("id", "errorBarTitle").attr("x", this.WIDTH / 2).attr("y", 0).attr("text-anchor", "middle").text(r).style("font-weight", "bold")
                }
            }, {
                key: "plotBars",
                value: function(t) {
                    var e = this,
                        i = (0, a.transition)().delay(500).duration(600),
                        n = (0, o.extent)(t, function(t) {
                            return t.name
                        }).reverse();
                    this.yScale.domain(n), this.yAxisGroup.transition(i).call((0, r.axisLeft)(this.yScale).tickSizeOuter(0)), this.xAxisGroup.transition(i).call((0, r.axisBottom)(this.xScale).ticks(4).tickSizeOuter(0)).selectAll("line.tick").style("opacity", .1), this.rects = this.svg.selectAll("rect.errorBar").data(t, function(t) {
                        return t.name
                    }), this.rects.exit().transition(i).attr("width", 0).attr("height", 0).attr("y", this.HEIGHT).remove(), this.rects.transition(i).attr("x", function(t) {
                        return e.xScale(0)
                    }).attr("y", function(t) {
                        return e.yScale(t.name)
                    }).attr("width", function(t) {
                        return e.xScale(+t.error)
                    }).attr("height", this.yScale.bandwidth()), this.rects.enter().append("rect").attr("class", "errorBar").attr("x", function(t) {
                        return e.xScale(0)
                    }).attr("y", function(t) {
                        return e.yScale(t.name)
                    }).attr("height", this.yScale.bandwidth()).attr("fill", function(t) {
                        return e.colorScale(t.name)
                    }).transition(i).attr("width", function(t) {
                        return e.xScale(+t.error)
                    })
                }
            }, {
    ...
    "jeiC": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.annotate = _, exports.annotationGroup = m;
        ...
        function l(t, e, s, i, n, o, r, h) {
            ...
            for (let l = f; l < 2 * Math.PI + f - .01; l += t) {
                const t = [a(o, h) + e + i * Math.cos(l), a(o, h) + s + n * Math.sin(l)];
                c.push(t), u.push(t)
            }
        ...
        function d(e, r, h, a, c, u) {
            ...
            switch (h.type) {
                ...
                case "circle": {
                    ...
                    for (let r = 0; r < a; r++) f.push(o(i, n, e, s, m));
                    break
                }
                case "highlight": {
        ...
        class p {
            ...
            render(t, e) {
                ...
                for (let h = 0; h < i.length; h++) {
                    const e = o * (i[h].w / n);
                    d(t, i[h], s, r + this._animationDelay, e, this._seed), r += e
                }
        ...
        function m(t) {
            ...
            for (const i of t) {
                const t = i;
                t._animationDelay = e, e += 0 === t.animationDuration ? 0 : t.animationDuration || 800
            }
            const s = [...t];
            return {
                show() {
    ...
    "Lzqi": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.a9 = exports.a8 = exports.a7 = exports.a6 = exports.a5 = exports.a4 = exports.a3 = exports.a11 = exports.a10 = void 0;
        var t = require("rough-notation"),
            e = "rgba(255, 241, 118, .5)",
            o = "skyblue",
            i = "rgba(0,128,128, .8)",
            r = document.querySelector("#bias"),
            a = document.querySelector("#variance"),
            n = document.querySelector("#overfit-highlight"),
            h = document.querySelector("#underfit-highlight"),
            l = document.querySelector("#underfit-def"),
            d = document.querySelector("#overfit-def"),
            s = document.querySelector("#bias-def"),
            c = document.querySelector("#variance-def"),
            u = document.querySelector("#balance-def"),
            p = document.querySelector("#decomp-highlight"),
            g = document.querySelector("#conclusion"),
            y = (0, t.annotate)(r, {
                type: "highlight",
                color: o,
                strokeWidth: 1
        ...
        exports.a11 = w, setTimeout(function() {
            y.show()
    ...
    "VdR9": [function(require, module, exports) {
        var define;
        var global = arguments[3];
        var n, r = arguments[3];
        ! function(r, t) {
            "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof n && n.amd ? n(["exports"], t) : t((r = r || self).d3 = {})
        }(this, function(n) {
            "use strict";
            ...
            function r(n, r) {
                return function(n) {
                    ...
                    var t = [],
                        ...
                        o = void 0;
                    try {
                        for (var a, i = n[Symbol.iterator](); !(e = (a = i.next()).done) && (t.push(a.value), !r || t.length !== r); e = !0);
                    } catch (f) {
                        u = !0, o = f
                    } finally {
                        try {
            ...
            function t(n, r, t, e) {
                n = n.filter(function(n, e) {
                    var u = r(n, e),
                        o = t(n, e);
                    return null != u && isFinite(u) && null != o && isFinite(o)
                }), e && n.sort(function(n, t) {
                    return r(n) - r(t)
                });
                for (var u, o, a, i = n.length, f = new Float64Array(i), c = new Float64Array(i), l = 0, h = 0, v = 0; v < i;) a = n[v], f[v] = u = +r(a, v, n), c[v] = o = +t(a, v, n), l += (u - l) / ++v, h += (o - h) / v;
                for (var s = 0; s < i; ++s) f[s] -= l, c[s] -= h;
                return [f, c, l, h]
            }

            function e(n, r, t, e) {
                for (var u = 0, o = 0, a = n.length; o < a; o++) {
                    var i = n[o],
                        f = +r(i, o, n),
                        c = +t(i, o, n);
                    null != f && isFinite(f) && null != c && isFinite(c) && e(f, c, u++)
                }
            }

            function u(n, r, t, u, o) {
                var a = 0,
                    i = 0;
                return e(n, r, t, function(n, r) {
                    var t = r - o(n),
                        e = r - u;
                    a += t * t, i += e * e
                }), 1 - a / i
            ...
            function o(n) {
                return 180 * Math.atan2(n[1][1] - n[0][1], n[1][0] - n[0][0]) / Math.PI
            }

            function a(n, r, t) {
                for (var e = Math.log(r - n) * Math.LOG10E + 1 | 0, u = 1 * Math.pow(10, -e / 2 - 1), a = [f(n), f(r)], i = 0; c(a) && i < 1e4;);
                return a;
                ...
                function c(n) {
                    i++;
                    for (var r, t = n.length, e = !1, a = 0; a < t - 1; a++) {
                        var c = n[a],
                            l = n[a + 1],
                            h = [((r = [c, l])[0][0] + r[1][0]) / 2, (r[0][1] + r[1][1]) / 2],
                            v = f(h[0]),
                            s = o([c, h]),
                            g = o([c, v]);
                        Math.abs(s - g) > u && (n.splice(a + 1, 0, v), e = !0)
                    }
                    return e
                }
            }
            ...
            function f() {
                ...
                function a(a) {
                    var f = 0,
                        ...
                        s = n ? +n[0] : 1 / 0,
                        g = n ? +n[1] : -1 / 0;
                    e(a, t, o, function(r, t) {
                        c += (r - c) / ++f, l += (t - l) / f, h += (r * t - h) / f, v += (r * r - v) / f, n || (r < s && (s = r), r > g && (g = r))
                    });
                    var d = r(i(c, l, h, v), 2),
                        p = d[0],
                        M = d[1],
                    ...
                    return b.a = M, b.b = p, b.predict = y, b.rSquared = u(a, t, o, l, y), b
                }
            ...
            function c(n) {
                ...
                var r = n.length / 2;
                return r % 1 == 0 ? (n[r - 1] + n[r]) / 2 : n[Math.floor(r)]
            }
            var l = 2,
                h = 1e-12;
            ...
            function s(n, r, t) {
                var e = n[r],
                    ...
                    o = t[1] + 1;
                if (!(o >= n.length))
                    for (; r > u && n[o] - e <= e - n[u];) t[0] = ++u, t[1] = o, ++o
            }
            ...
            function g() {
                ...
                function f(f) {
                    var c, l, h, v, s = r(t(f, o, i), 4),
                        ...
                        m = 0,
                        F = 0;
                    for (c = 0; c < y;) l = g[c], h = d[c++], b += ((v = l * l) - b) / c, x += (v * l - x) / c, w += (v * v - w) / c, m += (l * h - m) / c, F += (v * h - F) / c;
                    var A = 0,
                        S = 0,
                        q = n ? +n[0] : 1 / 0,
                        E = n ? +n[1] : -1 / 0;
                    e(f, o, i, function(r, t) {
                        A += (t - A) / ++S, n || (r < q && (q = r), r > E && (E = r))
                    });
                    var L = w - b * b,
                        P = b * L - x * x,
                        j = (F * b - m * x) / P,
                        ...
                        I = -j * b,
                        O = function(n) {
                            return j * (n -= p) * n + k * n + I + M
                        },
                        _ = a(q, E, O);
                    return _.a = j, _.b = k - 2 * j * p, _.c = I - k * p + j * p * p + M, _.predict = O, _.rSquared = u(f, o, i, A, O), _
                }
            ...
            n.regressionExp = function() {
                ...
                function f(f) {
                    var c = 0,
                        ...
                        d = n ? +n[0] : 1 / 0,
                        p = n ? +n[1] : -1 / 0;
                    e(f, t, o, function(r, t) {
                        var e = Math.log(t),
                            u = r * t;
                        l += (t - l) / ++c, v += (u - v) / c, g += (r * u - g) / c, h += (t * e - h) / c, s += (u * e - s) / c, n || (r < d && (d = r), r > p && (p = r))
                    });
                    var M = r(i(v / l, h / l, s / l, g / l), 2),
                        y = M[0],
                        b = M[1];
                    y = Math.exp(y);
                    var x = function(n) {
                            return y * Math.exp(b * n)
                        },
                        w = a(d, p, x);
                    return w.a = y, w.b = b, w.predict = x, w.rSquared = u(f, t, o, l, x), w
                }
                return f.domain = function(r) {
                    return arguments.length ? (n = r, f) : n
                }, f.x = function(n) {
            ...
            }, n.regressionLinear = f, n.regressionLoess = function() {
                var n = function(n) {
                        return n[0]
                    },
                    e = function(n) {
                ...
                function o(o) {
                    for (var a = r(t(o, n, e, !0), 4), f = a[0], g = a[1], d = a[2], p = a[3], M = f.length, y = Math.max(2, ~~(u * M)), b = new Float64Array(M), x = new Float64Array(M), w = new Float64Array(M).fill(1), m = -1; ++m <= l;) {
                        for (var F = [0, y - 1], A = 0; A < M; ++A) {
                            for (var S = f[A], q = F[0], E = F[1], L = S - f[q] > f[E] - S ? q : E, P = 0, j = 0, k = 0, I = 0, O = 0, _ = 1 / Math.abs(f[L] - S || 1), G = q; G <= E; ++G) {
                                var Q = f[G],
                                    T = g[G],
                                    z = v(Math.abs(S - Q) * _) * w[G],
                                    B = Q * z;
                                P += z, j += B, k += T * z, I += T * B, O += Q * B
                            }
                            var C = r(i(j / P, k / P, I / P, O / P), 2),
                                D = C[0],
                                H = C[1];
                            b[A] = D + H * S, x[A] = Math.abs(g[A] - b[A]), s(f, A + 1, F)
                        }
                        if (m === l) break;
                        var J = c(x);
                        if (Math.abs(J) < h) break;
                        for (var K, N, R = 0; R < M; ++R) K = x[R] / (6 * J), w[R] = K >= 1 ? h : (N = 1 - K * K) * N
                    }
                    return function(n, r, t, e) {
                        for (var u, o = n.length, a = [], i = 0, f = 0, c = []; i < o; ++i) u = n[i] + t, c[0] === u ? c[1] += (r[i] - c[1]) / ++f : (f = 0, c[1] += e, c = [u, r[i]], a.push(c));
                        return c[1] += e, a
                    }(f, b, d, p)
                }
                return o.bandwidth = function(n) {
                    return arguments.length ? (u = n, o) : u
                }, o.x = function(r) {
                ...
                function c(c) {
                    var l = 0,
                        ...
                        p = n ? +n[1] : -1 / 0,
                        M = Math.log(f);
                    e(c, t, o, function(r, t) {
                        var e = Math.log(r) / M;
                        h += (e - h) / ++l, v += (t - v) / l, s += (e * t - s) / l, g += (e * e - g) / l, n || (r < d && (d = r), r > p && (p = r))
                    });
                    var y = r(i(h, v, s, g), 2),
                        b = y[0],
                        x = y[1],
                        w = function(n) {
                            return x * Math.log(n) / M + b
                        },
                        m = a(d, p, w);
                    return m.a = x, m.b = b, m.predict = w, m.rSquared = u(c, t, o, v, w), m
                }
                return c.domain = function(r) {
                    return arguments.length ? (n = r, c) : n
                }, c.x = function(n) {
                    return arguments.length ? (t = n, c) : t
                }, c.y = function(n) {
                    return arguments.length ? (o = n, c) : o
                }, c.base = function(n) {
                    return arguments.length ? (f = n, c) : f
                }, c
            }, n.regressionPoly = function() {
                var n, o = function(n) {
                        return n[0]
                    },
                    i = function(n) {
                ...
                function l(l) {
                    if (1 === c) {
                        var h = f().x(o).y(i).domain(n)(l);
                        return h.coefficients = [h.b, h.a], delete h.a, delete h.b, h
                    }
                    if (2 === c) {
                        var v = g().x(o).y(i).domain(n)(l);
                        return v.coefficients = [v.c, v.b, v.a], delete v.a, delete v.b, delete v.c, v
                    }
                    var s, d, p, M, y, b = r(t(l, o, i), 4),
                        x = b[0],
                        w = b[1],
                        m = b[2],
                        F = b[3],
                        ...
                        j = n ? +n[0] : 1 / 0,
                        k = n ? +n[1] : -1 / 0;
                    for (e(l, o, i, function(r, t) {
                            L += (t - L) / ++P, n || (r < j && (j = r), r > k && (k = r))
                        }), s = 0; s < E; ++s) {
                        for (p = 0, M = 0; p < A; ++p) M += Math.pow(x[p], s) * w[p];
                        for (S.push(M), y = new Float64Array(E), d = 0; d < E; ++d) {
                            for (p = 0, M = 0; p < A; ++p) M += Math.pow(x[p], s + d);
                            y[d] = M
                        }
                        q.push(y)
                    }
                    q.push(S);
                    var I = function(n) {
                            var r, t, e, u, o, a = n.length - 1,
                                i = [];
                            for (r = 0; r < a; ++r) {
                                for (u = r, t = r + 1; t < a; ++t) Math.abs(n[r][t]) > Math.abs(n[r][u]) && (u = t);
                                for (e = r; e < a + 1; ++e) o = n[e][r], n[e][r] = n[e][u], n[e][u] = o;
                                for (t = r + 1; t < a; ++t)
                                    for (e = a; e >= r; e--) n[e][t] -= n[e][r] * n[r][t] / n[r][r]
                            }
                            for (t = a - 1; t >= 0; --t) {
                                for (o = 0, e = t + 1; e < a; ++e) o += n[e][t] * i[e];
                                i[t] = (n[a][t] - o) / n[t][t]
                            }
                            return i
                        }(q),
                        O = function(n) {
                            n -= m;
                            var r = F + I[0] + I[1] * n + I[2] * n * n;
                            for (s = 3; s < E; ++s) r += I[s] * Math.pow(n, s);
                            return r
                        },
                        _ = a(j, k, O);
                    return _.coefficients = function(n, r, t, e) {
                        var u, o, a, i, f = Array(n);
                        for (u = 0; u < n; ++u) f[u] = 0;
                        for (u = n - 1; u >= 0; --u)
                            for (a = r[u], i = 1, f[u] += a, o = 1; o <= u; ++o) i *= (u + 1 - o) / o, f[u - o] += a * Math.pow(t, o) * i;
                        return f[0] += e, f
                    }(E, I, -m, F), _.predict = O, _.rSquared = u(l, o, i, L, O), _
                }
                ...
                function f(f) {
                    ...
                    e(f, t, o, function(r, t) {
                        var e = Math.log(r),
                            u = Math.log(t);
                        l += (e - l) / ++c, h += (u - h) / c, v += (e * u - v) / c, s += (e * e - s) / c, g += (t - g) / c, n || (r < d && (d = r), r > p && (p = r))
                    });
                    var M = r(i(l, h, v, s), 2),
                        y = M[0],
                        b = M[1];
                    y = Math.exp(y);
                    var x = function(n) {
                            return y * Math.pow(n, b)
                        },
                        w = a(d, p, x);
                    return w.a = y, w.b = b, w.predict = x, w.rSquared = u(f, t, o, g, x), w
                }
                return f.domain = function(r) {
                    return arguments.length ? (n = r, f) : n
                }, f.x = function(n) {
            ...
            }, n.regressionQuad = g, Object.defineProperty(n, "__esModule", {
                value: !0
            })
        });
    }, {}],
    "T9QU": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        ...
        var r = function(r, e) {
            var n, t;
            return (n = r, t = e, n.map(function(r, e) {
                return r - t[e]
            })).map(function(r) {
                return r * r
            }).reduce(function(r, e) {
        ...
        exports.meanSquaredError = r;
    }, {}],
    "BbGa": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Scatter = void 0;
        var t = require("d3-regression"),
            e = require("./meanSquaredError"),
            r = require("./dataFiles"),
            i = require("./constants"),
            n = require("d3-selection"),
            a = require("d3-axis"),
            o = require("d3-scale"),
            s = require("d3-shape"),
            l = require("d3-transition"),
            u = require("d3-array"),
            d = require("d3-ease");
        ...
        var m = function() {
            function l(e) {
                var i = this;
                f(this, l), this.element = e.element, this.trainData = r.trainData, this.testData = r.testData, this.margin = window.innerWidth <= 700 ? {
                    left: 20,
                    right: 1,
                    top: 15,
                    bottom: 30
                    ...
                    top: 15,
                    bottom: 40
                }, this.chartDims = (0, n.select)("#scroll-figure").node().getBoundingClientRect(), this.innerWidth = .85 * this.chartDims.width, this.innerHeight = .36 * window.innerHeight, this.radius = window.innerWidth < 700 ? 6 : 10, this.realizationScale = (0, o.scaleLinear)().domain((0, u.extent)(r.modelsData, function(t) {
                    return t.x
                })).range([0, this.innerWidth]), this.realizationLine = (0, s.line)().x(function(t) {
                    return i.realizationScale(t.x)
                }).y(function(t) {
                    return i.yScale(t[column])
                }).curve(s.curveCatmullRom.alpha(.5)), this.errorBar = e.errorBar, this.linearRegression = (0, t.regressionLinear)().x(function(t) {
                    return t.x
                }).y(function(t) {
                    return t.y
                }).domain([0, 16]), this.loopDraw = !0, this.drawBaseChart()
            }
            return h(l, [{
                key: "loop",
                value: function() {
                    var t = this,
                        e = arguments;
                    this.loopDraw = !0, e.length <= 0 || function r(i) {
                        !0 === t.loopDraw && (i >= e.length || "function" != typeof e[i] || window.setTimeout(function() {
                            e[i](), r(i + 1)
                        }, 110))
                    }(0)
                }
                ...
                value: function() {
                    var t = this;
                    this.xScale = (0, o.scaleLinear)().domain([-.05, 1.15]).range([0, this.innerWidth]), this.yScale = (0, o.scaleLinear)().domain([-1.4, 1.4]).range([this.innerHeight, 0]), this.lineGen = (0, s.line)().x(function(e) {
                        return t.xScale(e.x)
                    }).y(function(e) {
                        return t.yScale(e.y)
                    }).curve(s.curveCatmullRom.alpha(.5)), this.lineGenUF = (0, s.line)().x(function(e) {
                        return t.xScale(e.x)
                    }).y(function(e) {
                        return t.yScale(e.y_pred_uf)
                    }).curve(s.curveCatmullRom.alpha(.5)), this.lineGenOF = (0, s.line)().x(function(e) {
                        return t.xScale(e.x)
                    }).y(function(e) {
                        return t.yScale(e.y_pred_of)
                    }).curve(s.curveCatmullRom.alpha(.5)), this.xAxisGenerator = (0, a.axisBottom)(this.xScale).tickSizeOuter(0).ticks(4), this.yAxisGenerator = (0, a.axisLeft)(this.yScale).tickSizeOuter(0).ticks(4), this.scatterSvg = (0, n.select)(this.element).append("svg").attr("id", "scatter-svg").attr("width", this.innerWidth + this.margin.left + this.margin.right).attr("height", this.innerHeight + this.margin.top + this.margin.bottom), this.scatterPlot = this.scatterSvg.append("g").attr("transform", "translate(".concat(this.margin.left, ", ").concat(this.margin.top, ")")), this.xAxis = this.scatterPlot.append("g").attr("class", "axis").attr("id", "scatter-x-axis").call(this.xAxisGenerator).attr("transform", "translate(0, ".concat(this.innerHeight, ")")), this.yAxis = this.scatterPlot.append("g").attr("class", "axis").call(this.yAxisGenerator), this.scatterPlot.selectAll("circle.train").data(this.trainData).enter().append("circle").attr("class", "train").attr("r", this.radius).attr("cx", function(e) {
                        return t.xScale(e.x)
                    }).attr("cy", function(e) {
                        return t.yScale(e.y)
                    }), this.xLabel = this.scatterSvg.append("text").attr("id", "scatter-x-axis-label").attr("x", this.innerWidth / 2 + this.margin.left + this.margin.right).attr("y", this.innerHeight + this.margin.top + this.margin.bottom).text("X"), this.yLabel = this.scatterSvg.append("text").attr("id", "scatter-y-axis-label").attr("x", 0).attr("y", this.innerHeight / 2 + this.margin.top + 4).text("Y").style("fill", "black")
                }
            }, {
                key: "drawLineUnderfit",
                value: function() {
                    this.regressionLine = this.scatterPlot.selectAll("#regression-line-1").data([this.trainData], function(t) {
                        return t.x
                    }), this.regressionLine.enter().append("path").attr("id", "regression-line-1").merge(this.regressionLine).transition().ease(d.easeBack).duration(1500).attr("d", this.lineGenUF), (0, n.selectAll)("path#regression-line-1").lower()
                }
            }, {
                key: "drawLineOverfit",
                value: function() {
                    this.regressionLine = this.scatterPlot.selectAll("#regression-line-1").data([this.trainData], function(t) {
                        return t.x
                    }), this.regressionLine.enter().append("path").attr("id", "regression-line-1").merge(this.regressionLine).transition().ease(d.easeBack).duration(1500).attr("d", this.lineGenOF)
                }
            }, {
                key: "drawTrainErrorUnderfit",
                value: function() {
                    var t = this,
                        r = this.linearRegression(this.trainData),
                        i = r.a,
                        a = r.b,
                        o = this.trainData.map(function(t) {
                            return {
                                x: t.x,
                                y1: i * t.x + a,
                                y2: t.y
                        ...
                        s = this.scatterPlot.selectAll("line.errorLine").data(o),
                        l = s.enter().merge(s).append("line").attr("class", "errorLine").attr("x1", function(e) {
                            return t.xScale(e.x)
                        }).attr("x2", function(e) {
                            return t.xScale(e.x)
                        }).attr("y1", function(e) {
                            return t.yScale(e.y2)
                        }).attr("y2", function(e) {
                            return t.yScale(e.y2)
                        });
                    (0, n.selectAll)("line.errorLine").lower(), l.transition().duration(1e3).attr("y1", function(e) {
                        return t.yScale(e.y1)
                    });
                    var u = this.trainData.map(function(t) {
                            return t.y
                        }),
                        d = this.trainData.map(function(t) {
                            return i * t.x + a
                        }),
                ...
                value: function() {
                    var t = this,
                        ...
                        i = r.a,
                        a = r.b,
                        o = this.testData.map(function(t) {
                            return {
                                x: t.x,
                                y1: i * t.x + a,
                                y2: t.y
                        ...
                        s = this.scatterPlot.selectAll("line.testErrorLine").data(o);
                    s.enter().merge(s).append("line").attr("class", "testErrorLine").attr("x1", function(e) {
                        return t.xScale(e.x)
                    }).attr("x2", function(e) {
                        return t.xScale(e.x)
                    }).attr("y1", function(e) {
                        ...
                        return t.yScale(e.y2)
                    }).transition().duration(1e3).attr("y1", function(e) {
                        return t.yScale(e.y1)
                    }), (0, n.selectAll)("line.testErrorLine").lower(), this.scatterPlot.selectAll("circle.test").data(this.testData).enter().append("circle").attr("class", "test").attr("r", 0).attr("cx", function(e) {
                        return t.xScale(e.x)
                    }).attr("cy", function(e) {
                        return t.yScale(e.y)
                    }).transition().attr("r", 2 * this.radius).transition().attr("r", this.radius);
                    var l = this.testData.map(function(t) {
                            return t.y
                        }),
                        u = this.testData.map(function(t) {
                            return i * t.x + a
                        }),
                ...
                key: "drawBarsTestOverfit",
                value: function() {
                    var t = this,
                        r = this;

                    function i(t, e) {
                        for (var i = (t = t.node()).getTotalLength(), n = 0, a = i, o = (n + a) / 2; o >= n && o <= i;) {
                            var s = t.getPointAtLength(o);
                            if (Math.abs(s.x - e) < .1) return r.yScale.invert(s.y);
                            s.x > e ? a = o : n = o, o = (n + a) / 2
                        }
                    }
                    var a = this.testData.map(function(t) {
                            var e;
                            return c(e = {
                                x: t.x,
                                y1: i(r.regressionLine, r.xScale(t.x))
                            }, "y1", i(r.regressionLine, r.xScale(t.x))), c(e, "y2", t.y), e
                        }),
                        o = this.scatterPlot.selectAll("line.errorLineComplex").data(a),
                        s = o.enter().merge(o).append("line").attr("class", "errorLineComplex").attr("x1", function(e) {
                            return t.xScale(e.x)
                        }).attr("x2", function(e) {
                            return t.xScale(e.x)
                        }).attr("y1", function(e) {
                    ...
                    (0, n.selectAll)("line.errorLineComplex").lower(), s.transition().duration(1e3).attr("y1", function(e) {
                        return t.yScale(e.y1)
                    });
                    var l = this.testData.map(function(t) {
                            return t.y
                        ...
                        u = this.testData.map(function(t) {
                            return i(r.regressionLine, r.xScale(t.x))
                        }),
                        d = this.trainData.map(function(t) {
                            return t.y
                        }),
                        f = this.trainData.map(function(t) {
                            return i(r.regressionLine, r.xScale(t.x))
                        }),
                ...
                value: function(t, e) {
                    var i = this;
                    this.realizationLine.y(function(t) {
                        return i.yScale(t[e])
                    });
                    var a = this.scatterPlot.selectAll("#".concat(e)).data([r.modelsData]);
                    a.enter().append("path").attr("id", "".concat(e)).attr("class", "model-realization").attr("d", this.realizationLine).style("opacity", t).transition().style("opacity", t), (0, n.selectAll)("path.model-realization").lower()
                }
            }, {
                key: "drawUnderfitRealizations",
                value: function() {
                    var t = this;
                    this.addTitle("Simple Model Realizations");
                    var e = this;
                    this.underfitOpa = .3, this.goodFitOpa = 0, this.overfitOpa = 0, this.drawLoop = !1, (0, n.selectAll)("[id^='uf-preds']").remove(), (0, n.selectAll)("[id^='of-preds']").remove(), (0, n.selectAll)("[id^='good-preds']").remove(), this.errorBar.drawErrorBase(), window.setTimeout(function() {
                        e.drawLoop = !0
                    }, 120), this.loop(function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-0")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-1")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-2")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-3")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-4")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-5")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-6")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-7")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-8")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-9")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-10")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-11")
                    }, function() {
                        return t.modelRealization(t.underfitOpa, "uf-preds-12")
                    })
                }
            }, {
                key: "drawOverfitRealizations",
                value: function() {
                    var t = this,
                        e = this;
                    this.drawLoop = !1, this.overfitOpa = .3, this.underfitOpa = 0, this.goodFitOpa = 0, (0, n.selectAll)("[id^='uf-preds']").remove(), (0, n.selectAll)("[id^='of-preds']").remove(), (0, n.selectAll)("[id^='good-preds']").remove(), this.addTitle("Complex Model Realizations"), window.setTimeout(function() {
                        e.drawLoop = !0
                    }, 120), this.loop(function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-0")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-1")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-2")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-3")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-4")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-5")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-6")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-7")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-8")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-9")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-10")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-11")
                    }, function() {
                        return t.modelRealization(t.overfitOpa, "of-preds-12")
                    })
                }
            }, {
                key: "drawGoodRealizations",
                value: function() {
                    var t = this,
                        e = this;
                    this.drawLoop = !1, this.overfitOpa = 0, this.underfitOpa = 0, this.goodFitOpa = .3, (0, n.selectAll)("[id^='uf-preds']").remove(), (0, n.selectAll)("[id^='of-preds']").remove(), (0, n.selectAll)("[id^='good-preds']").remove(), this.addTitle("Balanced Model Realizations"), window.setTimeout(function() {
                        e.drawLoop = !0
                    }, 120), this.loop(function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-0")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-1")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-2")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-3")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-4")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-5")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-6")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-7")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-8")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-9")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-10")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-11")
                    }, function() {
                        return t.modelRealization(t.goodFitOpa, "good-preds-12")
                    })
                }
            }, {
                key: "addLegend",
                value: function() {
                    ...
                    n.append("text").attr("class", "scatter-legend-text").attr("x", 11.5).attr("y", 0).text(function(t) {
                        return t
                    });
                    var a = 0;
                    n.attr("transform", function(t) {
                        var r = a,
                            i = window.innerWidth <= 600 ? 3 : 10;
                        return a += e(this) + i, "translate(".concat(r, ", ", 0, ")")
                    }), r.attr("transform", function() {
                        return "translate(".concat((t.innerWidth - e(this)) / 2, ", 0)")
                    })
                }
            }, {
                key: "removeRealizationLines",
                value: function() {
                    this.overfitOpa = 0, this.underfitOpa = 0, this.goodFitOpa = .3, (0, n.selectAll)("[id^='uf-preds']").remove(), (0, n.selectAll)("[id^='of-preds']").remove(), (0, n.selectAll)("[id^='good-preds']").remove()
                }
            }, {
                key: "transitionUp5",
                value: function() {
                ...
                key: "addTitle",
                value: function(t) {
                    (0, n.select)(".scatter-title").remove(), this.scatterSvg.append("g").append("text").attr("class", "scatter-title").attr("x", this.innerWidth / 2 + this.margin.left).attr("y", 20).text(t).attr("text-anchor", "middle")
                }
            }]), l
        }();
        exports.Scatter = m;
    ...
    "HpL9": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        class i {
            ...
            constructor(t) {
                const s = t.length >> 1;
                if (s > 0 && "number" != typeof t[0]) throw new Error("Expected coords to contain numbers.");
                this.coords = t;
                const i = Math.max(2 * s - 5, 0);
                this._triangles = new Uint32Array(3 * i), this._halfedges = new Int32Array(3 * i), this._hashSize = Math.ceil(Math.sqrt(s)), this._hullPrev = new Uint32Array(s), this._hullNext = new Uint32Array(s), this._hullTri = new Uint32Array(s), this._hullHash = new Int32Array(this._hashSize).fill(-1), this._ids = new Uint32Array(s), this._dists = new Float64Array(s), this.update()
            }
            update() {
                const {
                    coords: s,
                ...
                for (let t = 0; t < c; t++) {
                    const i = s[2 * t],
                        e = s[2 * t + 1];
                    i < u && (u = i), e < f && (f = e), i > d && (d = i), e > g && (g = e), this._ids[t] = t
                }
                const y = (u + d) / 2,
                    w = (f + g) / 2;
                let b, A, k, x = 1 / 0;
                ...
                let T = s[2 * k],
                    K = s[2 * k + 1];
                if (p === 1 / 0) {
                    for (let e = 0; e < c; e++) this._dists[e] = s[2 * e] - s[0] || s[2 * e + 1] - s[1];
                    ...
                    return this.hull = t.subarray(0, i), this.triangles = new Uint32Array(0), void(this.halfedges = new Uint32Array(0))
                }
                if (r(M, S, z, U, T, K)) {
                    const t = A,
                        s = z,
                ...
                for (let t = 0; t < c; t++) this._dists[t] = h(s[2 * t], s[2 * t + 1], v.x, v.y);
                _(this._ids, this._dists, 0, c - 1), this._hullStart = b;
                let L = 3;
                e[b] = i[k] = A, e[A] = i[b] = k, e[k] = i[A] = b, n[b] = 0, n[A] = 1, n[k] = 2, l.fill(-1), l[this._hashKey(M, S)] = b, l[this._hashKey(z, U)] = A, l[this._hashKey(T, K)] = k, this.trianglesLen = 0, this._addTriangle(b, A, k, -1, -1, -1);
                for (let h, a, o = 0; o < this._ids.length; o++) {
                    const _ = this._ids[o],
                        c = s[2 * _],
                        u = s[2 * _ + 1];
                    if (o > 0 && Math.abs(c - h) <= t && Math.abs(u - a) <= t) continue;
                    if (h = c, a = u, _ === b || _ === A || _ === k) continue;
                    let f = 0;
                    for (let t = 0, s = this._hashKey(c, u); t < this._hashSize && (-1 === (f = l[(s + t) % this._hashSize]) || f === e[f]); t++);
                    let d, g = f = i[f];
                    for (; d = e[g], !r(c, u, s[2 * g], s[2 * g + 1], s[2 * d], s[2 * d + 1]);)
                        if ((g = d) === f) {
                            g = -1;
                            break
                        } if (-1 === g) continue;
                    ...
                    let w = e[g];
                    for (; d = e[w], r(c, u, s[2 * w], s[2 * w + 1], s[2 * d], s[2 * d + 1]);) y = this._addTriangle(w, _, d, n[_], -1, n[w]), n[_] = this._legalize(y + 2), e[w] = w, L--, w = d;
                    if (g === f)
                        for (; r(c, u, s[2 * (d = i[g])], s[2 * d + 1], s[2 * g], s[2 * g + 1]);) y = this._addTriangle(d, _, g, -1, n[g], n[d]), this._legalize(y + 2), n[d] = y, e[g] = g, L--, g = d;
                    this._hullStart = i[_] = g, e[g] = i[w] = _, e[_] = w, l[this._hashKey(c, u)] = _, l[this._hashKey(s[2 * g], s[2 * g + 1])] = g
                }
                this.hull = new Uint32Array(L);
                for (let t = 0, h = this._hullStart; t < L; t++) this.hull[t] = h, h = e[h];
                this.triangles = this._triangles.subarray(0, this.trianglesLen), this.halfedges = this._halfedges.subarray(0, this.trianglesLen)
            }
            _hashKey(t, s) {
                return Math.floor(e(t - this._cx, s - this._cy) * this._hashSize) % this._hashSize
            }
            _legalize(t) {
                const {
                    _triangles: i,
                ...
                for (;;) {
                    ...
                    const _ = a - a % 3,
                        ...
                        g = i[c],
                        y = i[u];
                    if (l(h[2 * f], h[2 * f + 1], h[2 * d], h[2 * d + 1], h[2 * g], h[2 * g + 1], h[2 * y], h[2 * y + 1])) {
                        i[t] = y, i[a] = f;
                        const h = e[u];
                        if (-1 === h) {
            ...
            _addTriangle(t, s, i, e, h, n) {
                ...
                return this._triangles[r] = t, this._triangles[r + 1] = s, this._triangles[r + 2] = i, this._link(r, e), this._link(r + 1, h), this._link(r + 2, n), this.trianglesLen += 3, r
            }
        }
        ...
        function n(t, s, i, e, h, n) {
            const r = (e - s) * (h - t),
                l = (i - t) * (n - s);
            return Math.abs(r - l) >= 3.3306690738754716e-16 * Math.abs(r + l) ? r - l : 0
        }

        function r(t, s, i, e, h, r) {
            return (n(h, r, t, s, i, e) || n(t, s, i, e, h, r) || n(i, e, h, r, t, s)) < 0
        }
        ...
        function l(t, s, i, e, h, n, r, l) {
            const a = t - r,
                ...
                d = _ * _ + c * c,
                g = u * u + f * f;
            return a * (c * g - d * f) - o * (_ * g - d * u) + (a * a + o * o) * (_ * f - c * u) < 0
        }
        ...
        function _(t, s, i, e) {
            if (e - i <= 20)
                for (let h = i + 1; h <= e; h++) {
                    ...
                    let h = i + 1,
                        n = e;
                    c(t, i + e >> 1, h), s[t[i]] > s[t[e]] && c(t, i, e), s[t[h]] > s[t[e]] && c(t, h, e), s[t[i]] > s[t[h]] && c(t, i, h);
                    const r = t[h],
                        l = s[r];
                    for (;;) {
                        do {
                    ...
                    t[i + 1] = t[n], t[n] = r, e - h + 1 >= n - i ? (_(t, s, h, e), _(t, s, i, n - 1)) : (_(t, s, i, n - 1), _(t, s, h, e))
                }
        }
    ...
    "Jacx": [function(require, module, exports) {
        ...
        class s {
            ...
            moveTo(t, s) {
                this._ += `M${this._x0=this._x1=+t},${this._y0=this._y1=+s}`
            }
            closePath() {
                null !== this._x1 && (this._x1 = this._x0, this._y1 = this._y0, this._ += "Z")
            }
            ...
            arc(s, i, h) {
                ...
                null === this._x1 ? this._ += `M${_},${e}` : (Math.abs(this._x1 - _) > t || Math.abs(this._y1 - e) > t) && (this._ += "L" + _ + "," + e), h && (this._ += `A${h},${h},0,1,1,${s-h},${i}A${h},${h},0,1,1,${this._x1=_},${this._y1=e}`)
            }
            rect(t, s, i, h) {
                this._ += `M${this._x0=this._x1=+t},${this._y0=this._y1=+s}h${+i}v${+h}h${-i}Z`
            }
            value() {
                return this._ || null
            }
    ...
    "j03y": [function(require, module, exports) {
        ...
        class n {
            constructor(t, [e, i, n, s] = [0, 0, 960, 500]) {
                if (!((n = +n) >= (e = +e) && (s = +s) >= (i = +i))) throw new Error("invalid bounds");
                this.delaunay = t, this._circumcenters = new Float64Array(2 * t.points.length), this.vectors = new Float64Array(2 * t.points.length), this.xmax = n, this.xmin = e, this.ymax = s, this.ymin = i, this._init()
            }
            update() {
            ...
            _init() {
                const {
                    ...
                    vectors: n
                } = this, s = this.circumcenters = this._circumcenters.subarray(0, i.length / 3 * 2);
                ...
                let h, l, r, o = e[e.length - 1],
                    a = 4 * o,
                    c = t[2 * o],
                    u = t[2 * o + 1];
                n.fill(0);
                for (let m = 0; m < e.length; ++m) h = a, l = c, r = u, a = 4 * (o = e[m]), c = t[2 * o], u = t[2 * o + 1], n[h + 2] = n[a] = r - u, n[h + 3] = n[a + 1] = c - l
            }
            render(e) {
            ...
            renderBounds(e) {
                const i = null == e ? e = new t.default : void 0;
                return e.rect(this.xmin, this.ymin, this.xmax - this.xmin, this.ymax - this.ymin), i && i.value()
            }
            renderCell(e, i) {
                ...
                for (let t = 2; t < h; t += 2) s[t] === s[t - 2] && s[t + 1] === s[t - 1] || i.lineTo(s[t], s[t + 1]);
            ...
            _renderSegment(t, e, i, n, s) {
                ...
                0 === l && 0 === r ? (s.moveTo(t, e), s.lineTo(i, n)) : (h = this._clipSegment(t, e, i, n, l, r)) && (s.moveTo(h[0], h[1]), s.lineTo(h[2], h[3]))
            }
            contains(t, e, i) {
                ...
                if (e)
                    for (const i of this.delaunay.neighbors(t)) {
                        ...
                        if (t) t: for (let n = 0, s = e.length; n < s; n += 2)
                            for (let h = 0, l = t.length; h < l; h += 2)
                                if (e[n] == t[h] && e[n + 1] == t[h + 1] && e[(n + 2) % s] == t[(h + l - 2) % l] && e[(n + 3) % s] == t[(h + l - 1) % l]) {
                                    yield i;
                                    break t
                                }
                    }
            ...
            _cell(t) {
                ...
                do {
                    ...
                    if (l.push(e[2 * i], e[2 * i + 1]), s[r = r % 3 == 2 ? r - 2 : r + 1] !== t) break;
                    r = n[r]
                } while (r !== h && -1 !== r);
                return l
            }
            _clip(t) {
                ...
                return i[n] || i[n + 1] ? this._clipInfinite(t, e, i[n], i[n + 1], i[n + 2], i[n + 3]) : this._clipFinite(t, e)
            }
            _clipFinite(t, e) {
                const i = e.length;
                let n, s, h, l, r, o = null,
                    a = e[i - 2],
                    c = e[i - 1],
                    u = this._regioncode(a, c);
                for (let m = 0; m < i; m += 2)
                    if (n = a, s = c, a = e[m], c = e[m + 1], h = u, u = this._regioncode(a, c), 0 === h && 0 === u) l = r, r = 0, o ? o.push(a, c) : o = [a, c];
                    else {
                        let e, i, m, x, d;
                        if (0 === h) {
                            if (null === (e = this._clipSegment(n, s, a, c, h, u))) continue;
                            [i, m, x, d] = e
                        } else {
                            if (null === (e = this._clipSegment(a, c, n, s, u, h))) continue;
                            [x, d, i, m] = e, l = r, r = this._edgecode(i, m), l && r && this._edge(t, l, r, o, o.length), o ? o.push(i, m) : o = [i, m]
                        }
                        l = r, r = this._edgecode(x, d), l && r && this._edge(t, l, r, o, o.length), o ? o.push(x, d) : o = [x, d]
                    } if (o) l = r, r = this._edgecode(o[0], o[1]), l && r && this._edge(t, l, r, o, o.length);
            ...
            _clipSegment(t, e, i, n, s, h) {
                for (;;) {
                    ...
                    if (s & h) return null;
                    let l, r, o = s || h;
                    8 & o ? (l = t + (i - t) * (this.ymax - e) / (n - e), r = this.ymax) : 4 & o ? (l = t + (i - t) * (this.ymin - e) / (n - e), r = this.ymin) : 2 & o ? (r = e + (n - e) * (this.xmax - t) / (i - t), l = this.xmax) : (r = e + (n - e) * (this.xmin - t) / (i - t), l = this.xmin), s ? (t = l, e = r, s = this._regioncode(t, e)) : (i = l, n = r, h = this._regioncode(i, n))
                }
            }
            _clipInfinite(t, e, i, n, s, h) {
                let l, r = Array.from(e);
                if ((l = this._project(r[0], r[1], i, n)) && r.unshift(l[0], l[1]), (l = this._project(r[r.length - 2], r[r.length - 1], s, h)) && r.push(l[0], l[1]), r = this._clipFinite(t, r))
                    for (let o, a = 0, c = r.length, u = this._edgecode(r[c - 2], r[c - 1]); a < c; a += 2) o = u, u = this._edgecode(r[a], r[a + 1]), o && u && (a = this._edge(t, o, u, r, a), c = r.length);
                else this.contains(t, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2) && (r = [this.xmin, this.ymin, this.xmax, this.ymin, this.xmax, this.ymax, this.xmin, this.ymax]);
                return r
            }
            _edge(t, e, i, n, s) {
                for (; e !== i;) {
                    ...
                    n[s] === i && n[s + 1] === h || !this.contains(t, i, h) || (n.splice(s, 0, i, h), s += 2)
                }
                if (n.length > 4)
                    for (let h = 0; h < n.length; h += 2) {
                        const t = (h + 2) % n.length,
                            e = (h + 4) % n.length;
                        (n[h] === n[t] && n[t] === n[e] || n[h + 1] === n[t + 1] && n[t + 1] === n[e + 1]) && (n.splice(t, 2), h -= 2)
                    }
                return s
            }
            _project(t, e, i, n) {
                ...
                if (n < 0) {
                    ...
                    (s = (this.ymin - e) / n) < r && (l = this.ymin, h = t + (r = s) * i)
                } else if (n > 0) {
                    if (e >= this.ymax) return null;
                    (s = (this.ymax - e) / n) < r && (l = this.ymax, h = t + (r = s) * i)
                }
                if (i > 0) {
                    if (t >= this.xmax) return null;
                    (s = (this.xmax - t) / i) < r && (h = this.xmax, l = e + (r = s) * n)
                } else if (i < 0) {
                    if (t <= this.xmin) return null;
                    (s = (this.xmin - t) / i) < r && (h = this.xmin, l = e + (r = s) * n)
                }
                return [h, l]
            }
            _edgecode(t, e) {
    ...
    "UFGE": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        function a(t) {
            ...
            for (let l = 0; l < e.length; l += 3) {
                const t = 2 * e[l],
                    r = 2 * e[l + 1],
                    i = 2 * e[l + 2];
                if ((n[i] - n[t]) * (n[r + 1] - n[t + 1]) - (n[r] - n[t]) * (n[i + 1] - n[t + 1]) > 1e-10) return !1
            }
            return !0
        }
        ...
        class d {
            static from(t, e = s, n = h, l) {
                return new d("length" in t ? c(t, e, n, l) : Float64Array.from(f(t, e, n, l)))
            }
            constructor(e) {
                this._delaunator = new t.default(e), this.inedges = new Int32Array(e.length / 2), this._hullIndex = new Int32Array(e.length / 2), this.points = this._delaunator.coords, this._init()
            }
            update() {
            ...
            _init() {
                ...
                if (e.hull && e.hull.length > 2 && a(e)) {
                    this.collinear = Int32Array.from({
                        length: n.length / 2
                    }, (t, e) => e).sort((t, e) => n[2 * t] - n[2 * e] || n[2 * t + 1] - n[2 * e + 1]);
                ...
                for (let t = 0, h = l.length; t < h; ++t) {
                    const e = i[t % 3 == 2 ? t - 2 : t + 1]; - 1 !== l[t] && -1 !== o[e] || (o[e] = t)
                }
            ...
            voronoi(t) {
                ...
                let h = s,
                    a = -1;
                do {
                    if (yield a = i[h], i[h = h % 3 == 2 ? h - 2 : h + 1] !== t) return;
                    if (-1 === (h = r[h])) {
            ...
            find(t, e, n = 0) {
                ...
                let r;
                for (;
                    (r = this._step(n, t, e)) >= 0 && r !== n && r !== l;) n = r;
                return r
            }
            _step(t, e, n) {
                const {
                ...
                do {
                    ...
                    if (c < d && (d = c, u = l), h[f = f % 3 == 2 ? f - 2 : f + 1] !== t) break;
                    if (-1 === (f = s[f])) {
                        if ((f = r[(i[t] + 1) % r.length]) !== l && o(e - a[2 * f], 2) + o(n - a[2 * f + 1], 2) < d) return f;
                        break
                    }
                } while (f !== c);
                return u
            ...
            renderTriangle(t, n) {
                const l = null == n ? n = new e.default : void 0,
                    ...
                    s = 2 * i[t + 1],
                    h = 2 * i[t + 2];
                return n.moveTo(r[o], r[o + 1]), n.lineTo(r[s], r[s + 1]), n.lineTo(r[h], r[h + 1]), n.closePath(), l && l.value()
            }* trianglePolygons() {
                const {
                    triangles: t
                } = this;
        ...
        function c(t, e, n, l) {
            ...
            for (let o = 0; o < r; ++o) {
                const r = t[o];
                i[2 * o] = e.call(l, r, o, t), i[2 * o + 1] = n.call(l, r, o, t)
            }
            return i
        }
        ...
        function* f(t, e, n, l) {
            let r = 0;
            for (const i of t) yield e.call(l, i, r, t), yield n.call(l, i, r, t), ++r
        }
        exports.default = d;
    }, {
        "delaunator": "HpL9",
    ...
    "V5JR": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "ennA": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = e;
        var n = Math.PI / 3,
            r = [0, n, 2 * n, 3 * n, 4 * n, 5 * n];
        ...
        function e() {
            ...
            function v(n) {
                var r, t = {},
                    ...
                    e = n.length;
                for (r = 0; r < e; ++r)
                    if (!isNaN(c = +s.call(null, i = n[r], r, n)) && !isNaN(f = +h.call(null, i, r, n))) {
                        var i, c, f, l = Math.round(f /= o),
                            v = Math.round(c = c / a - (1 & l) / 2),
                            M = f - l;
                        if (3 * Math.abs(M) > 1) {
                            var d = c - v,
                                p = v + (c < v ? -1 : 1) / 2,
                                ...
                                x = c - p,
                                m = f - g;
                            d * d + M * M > x * x + m * m && (v = p + (1 & l ? 1 : -1) / 2, l = g)
                        }
                        var j = v + "-" + l,
                            N = t[j];
                        N ? N.push(i) : (u.push(N = t[j] = [i]), N.x = (v + (1 & l) / 2) * a, N.y = l * o)
                    } return u
            }
            ...
            return v.hexagon = function(n) {
                return "m" + M(null == n ? e : +n).join("l") + "z"
            }, v.centers = function() {
                for (var n = [], r = Math.round(c / o), t = Math.round(i / a), u = r * o; u < l + e; u += o, ++r)
                    for (var s = t * a + (1 & r) * a / 2; s < f + a / 2; s += a) n.push([s, u]);
                return n
            }, v.mesh = function() {
                var n = M(e).slice(0, 4).join("l");
                return v.centers().map(function(r) {
                    return "M" + r + "m" + n
                }).join("")
            }, v.x = function(n) {
                return arguments.length ? (s = n, v) : s
            }, v.y = function(n) {
                return arguments.length ? (h = n, v) : h
            }, v.radius = function(r) {
                return arguments.length ? (a = 2 * (e = +r) * Math.sin(n), o = 1.5 * e, v) : e
            }, v.size = function(n) {
                return arguments.length ? (i = c = 0, f = +n[0], l = +n[1], v) : [f - i, l - c]
            }, v.extent = function(n) {
                return arguments.length ? (i = +n[0][0], c = +n[0][1], f = +n[1][0], l = +n[1][1], v) : [
                    [i, c],
                    [f, l]
                ]
            }, v.radius(1)
    ...
    "yGzv": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
    ...
    "FIMl": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.KNN = void 0;
        var t = require("d3-selection"),
            e = require("d3-scale"),
            r = require("d3-shape"),
            n = require("d3-transition"),
            i = require("d3-array"),
            a = require("d3-delaunay"),
            s = l(require("d3-hexbin"));
        ...
        function f(t, e) {
            ...
            if (null != r) {
                var n, i, a = [],
                    ...
                    o = !1;
                try {
                    for (r = r.call(t); !(s = (n = r.next()).done) && (a.push(n.value), !e || a.length !== e); s = !0);
                } catch (l) {
                    o = !0, i = l
                } finally {
                    try {
        ...
        var x = function(t, e) {
            ...
            k = function(t) {
                return t - .1 * Math.pow(t, 2) - 1.1 * Math.sin(t) + 4
            },
            m = 65,
            w = function() {
                function n(r) {
                    ...
                    y(this, n);
                    var l = this;
                    this.fitContainer = r.fitContainer, this.predictContainer = r.predictContainer, this.sliderContainer = r.sliderContainer, this.k = r.k, this.fitPointRadius = 6, this.hexRadius = 8, this.MARGIN = {
                        TOP: 0,
                        BOTTOM: 0,
                        LEFT: 0,
                        RIGHT: 0
                    };
                    var h = (0, t.select)("#".concat(this.fitContainer)).node().getBoundingClientRect();

                    function c(t, e) {
                        return Math.random() > .9 ? Math.round(Math.random()) : function(t, e) {
                            var r = t / l.WIDTH * 10 + 1.5;
                            return (l.HEIGHT - e) / l.HEIGHT * 10 < k(r) ? 0 : 1
                        }(t, e)
                    }
                    this.WIDTH = .9 * h.width, this.HEIGHT = window.innerWidth <= 600 ? .7 * h.height : .85 * h.height, this.padding = 40, this.classColorScale = (0, e.scaleOrdinal)().domain([0, 1]).range(["#94CAE0", "#E57873"]), this.cellColor = (0, e.scaleQuantize)().domain([-.8, .8]).range(["#94CAE0", "rgba(148, 202, 224, 0.5)", "rgba(229, 120, 115, 0.5)", "#E57873"]), this.xAcc = function(t) {
                        return +t[0]
                    }, this.yAcc = function(t) {
                        return +t[1]
                    }, this.hexbin = s.hexbin().radius(this.hexRadius).extent([
                        [0, 0],
                        [this.WIDTH, this.HEIGHT]
                    ]), this.hexCenters = this.hexbin(this.hexbin.centers()), this.delan = a.Delaunay.from(this.hexCenters, function(t) {
                        return t.x
                    }, function(t) {
                        return t.y
                    }), this.trainData = (0, i.range)(m).map(function() {
                        var t = Math.random() * (o.WIDTH - o.padding) + o.padding / 2,
                            e = Math.random() * (o.HEIGHT - o.padding) + o.padding / 2;
                        return [t, e, c(t, e)]
                    }), this.addSlider(), this.fitG = this.initChartSvg(this.fitContainer), this.predictG = this.initChartSvg(this.predictContainer), this.drawKnnLeft(), this.drawKnnRight()
                }
                return v(n, [{
                    key: "refreshChartWithNewData",
                    value: function() {
                        var t = this,
                            e = this,
                            r = function(t) {
                        ...
                        function n(t, n) {
                            return Math.random() > .9 ? Math.round(Math.random()) : function(t, n) {
                                var i = t / e.WIDTH * 10 + 1.5;
                                return (e.HEIGHT - n) / e.HEIGHT * 10 < r(i) ? 0 : 1
                            }(t, n)
                        }
                        this.trainData = (0, i.range)(m).map(function() {
                            var e = Math.random() * (t.WIDTH - t.padding) + t.padding / 2,
                                r = Math.random() * (t.HEIGHT - t.padding) + t.padding / 2;
                            return [e, r, n(e, r)]
                        }), this.drawKnnLeft(), this.drawKnnRight()
                    }
                }, {
                    key: "drawKnnLeft",
                    value: function() {
                        var e = this,
                            r = this;
                        [".data-point", ".highlight-circle", "mesh-g-fit", ".overlay", ".hex-cell", ".line-g", ".mesh-g-fit"].map(function(e) {
                            (0, t.selectAll)(e).remove()
                        });
                        var n = a.Delaunay.from(this.hexCenters, function(t) {
                            return t.x
                        }, function(t) {
                            return t.y
                        });
                        this.fitG.selectAll(".data-point").data(this.trainData).enter().append("circle").classed("data-point", !0).attr("r", this.fitPointRadius).attr("cx", this.xAcc).attr("cy", this.yAcc).attr("fill", function(t) {
                            return e.classColorScale(t[2])
                        }).style("stroke", "white");
                        this.fitG.append("circle").attr("class", "highlight-circle").attr("r", this.fitPointRadius).style("fill", "black").style("stroke", "white"), this.fitG.append("g").attr("class", "mesh-g-fit").selectAll("path").data(this.hexCenters).enter().append("path").attr("class", "hex-cell-fit").attr("d", function(t) {
                            return "M".concat(t.x, ",").concat(t.y).concat(e.hexbin.hexagon())
                        }).attr("fill", "white").attr("stroke-width", 0).attr("stroke", "white").attr("opacity", 0), this.fitG.append("rect").attr("class", "overlay").attr("width", r.WIDTH).attr("height", r.HEIGHT).style("opacity", 0).on("mousemove", function(e) {
                            var i = h((0, t.pointer)(e), 2),
                                a = i[0],
                                s = i[1],
                                o = n.find(a, s),
                                l = r.hexCenters[o],
                            ...
                            r.highlight(c, r.k), (0, t.selectAll)(".hex-cell").filter(function(t) {
                                return t.x === l.x && t.y === l.y
                            }).attr("stroke", "black").attr("stroke-width", 3).raise(), (0, t.selectAll)(".hex-cell").filter(function(t) {
                                return t.x !== l.x || t.y !== l.y
                            }).attr("stroke-width", 0).style("stroke", "#161E2D")
                        }).on("mouseleave", this.hexLeave), this.highlight(this.hexCenters[60], this.k), this.addDecisionLine(this.fitG)
                    }
                }, {
                    key: "hexLeave",
                    value: function() {
                        (0, t.selectAll)(".hex-cell").attr("stroke-width", 0)
                    }
                }, {
                    key: "highlight",
                    value: function(e, r) {
                        this.k = r, (0, t.select)(".highlight-circle").style("display", "").attr("cx", e.x).attr("cy", e.y).attr("stroke", "black"), (0, t.selectAll)(".neighbor-line").remove();
                        var n = [e.x, e.y],
                            i = b(this.trainData, n, this.k);
                        this.fitG.selectAll(".polygon").style("fill", "white");
                        var a = this.trainData.filter(function(t, e) {
                            return i.indexOf(e) > -1
                        });
                        this.fitG.selectAll(".line").data(a).enter().append("line").attr("class", "neighbor-line").attr("x1", function(t) {
                            return n[0]
                        }).attr("y1", function(t) {
                            return n[1]
                        }).attr("x2", this.xAcc).attr("y2", this.yAcc).attr("stroke", "#161E2D").style("stroke-width", 2.5).style("pointer-events", "none").style("opacity", .45).lower(), this.lastDataHovered = e
                    }
                }, {
                    key: "addDecisionLine",
                    value: function(t) {
                        var e = this,
                            n = (0, r.line)().x(function(t) {
                                return t.x
                            }).y(function(t) {
                                return t.y
                            }).curve(r.curveCatmullRom.alpha(.95));
                        t.append("g").attr("class", "line-g").selectAll(".boundary").data([function() {
                            for (var t = [], r = 1.5; r <= 11.5; r += 1) t.push({
                                x: (r - 1.5) / 10 * e.WIDTH,
                                y: e.HEIGHT - k(r) / 10 * e.HEIGHT
                            });
                            return t
                        }()]).enter().append("path").attr("d", n).attr("class", "boundary").attr("fill", "none").attr("stroke", "#161E2D").attr("stroke-width", 4).attr("opacity", .5).style("stroke-dasharray", "5, 5").style("pointer-events", "none"), t.select("path.boundary").lower()
                    }
                }, {
                    key: "drawKnnRight",
                    value: function() {
                        var e = this,
                            r = this;
                        [".mesh-g", ".hex-cell"].map(function(t) {
                            e.predictG.selectAll(t).remove()
                        });
                        var n = a.Delaunay.from(this.hexCenters, function(t) {
                            return t.x
                        }, function(t) {
                        ...
                        this.predictG.append("g").attr("class", "mesh-g").selectAll("path").data(this.hexCenters).enter().append("path").attr("class", "hex-cell").attr("d", function(t) {
                            return "M".concat(t.x, ",").concat(t.y).concat(e.hexbin.hexagon())
                        }).attr("stroke-width", 0).attr("stroke", "#161E2D"), this.predictG.append("rect").attr("class", "overlay").attr("width", this.WIDTH).attr("height", this.HEIGHT).style("opacity", 0).on("mousemove", function(e) {
                            var i = h((0, t.pointer)(e), 2),
                                a = i[0],
                                s = i[1],
                                o = n.find(a, s),
                                l = r.hexCenters[o];
                            r.highlight(l, r.k), (0, t.selectAll)(".hex-cell").filter(function(t) {
                                return t.x === l.x && t.y === l.y
                            }).attr("stroke", "black").attr("stroke-width", 3).raise(), (0, t.selectAll)(".hex-cell").filter(function(t) {
                                return t.x !== l.x || t.y !== l.y
                            }).attr("stroke-width", 0).style("stroke", "#161E2D"), (0, t.select)(".highlight-circle").style("display", "").attr("cx", l.x).attr("cy", l.y).attr("stroke", "black")
                        }).on("mouseleave", this.hexLeave), this.addDecisionLine(this.predictG), this.updateHexGrid(this.k)
                    }
                }, {
                    key: "updateHexGrid",
                    value: function(e) {
                        var r = this;
                        (0, t.selectAll)(".hex-cell").each(function(n, i) {
                            var a = function(t, e, n) {
                                var i = H(t, e, n).map(function(t) {
                                        return t[2]
                                    }),
                                ...
                                return r.cellColor(s)
                            }(r.trainData, n[0], e);
                            (0, t.select)(this).attr("fill", a).attr("stroke", a)
                        })
                    }
                }, {
                    key: "addSlider",
                    value: function() {
                        ...
                        r.append("h4").attr("id", "k-text").html("K: ".concat(this.k)), r.append("input").attr("class", "metric-slider").attr("type", "range").attr("value", "".concat(this.k)).attr("min", 1).attr("max", m).attr("step", 2).attr("maxlength", "100"), (0, t.selectAll)(".metric-slider").on("input", function(r) {
                            var n = (0, t.select)(this).property("value"),
                                i = Number(n);
                            this.k = i, (0, t.select)("#k-text").html("K: ".concat(this.k)), e.highlight(e.lastDataHovered, this.k), e.updateHexGrid(this.k)
                        })
                    }
                }, {
                    key: "initChartSvg",
                    value: function(e) {
                        return (0, t.select)("#".concat(e)).append("svg").attr("id", "".concat(e, "-svg")).attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).attr("height", this.HEIGHT + this.MARGIN.TOP + this.MARGIN.BOTTOM).style("border", "1px solid rgba(0, 0, 0, 0.3)").append("g").attr("id", "".concat(e, "-g")).attr("transform", "translate(".concat(this.MARGIN.LEFT, ", ").concat(this.MARGIN.TOP, ")"))
                    }
                }]), n
            }();

        function b(t, e, r) {
            for (var n = [], i = 0; i < t.length; i++) n.push([i, x(t[i], e)]);
            n.sort(function(t, e) {
                return t[1] - e[1]
            });
            for (var a = [], s = 0; s < r; s++) a.push(n[s][0]);
            return a
        }

        function H(t, e, r) {
            for (var n = [], i = 0; i < t.length; i++) n.push([i, x(t[i], e), t[i]]);
            n.sort(function(t, e) {
                return t[1] - e[1]
            });
            for (var a = [], s = 0; s < r; s++) a.push(n[s][2]);
            return a
        }
        exports.KNN = w;
    }, {
    ...
    "z6Ua": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        var r = function e(t) {
            function r(e, r) {
                return arguments.length < 2 && (r = e, e = 0), e = Math.floor(e), r = Math.floor(r) - e,
                    function() {
    ...
    "qEyw": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "QFQ4": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "dJot": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        var t = function e(r) {
            function t(e) {
                if ((e = +e) < 0 || e > 1) throw new RangeError("invalid p");
                return 0 === e ? () => 1 / 0 : 1 === e ? () => 1 : (e = Math.log1p(-e), function() {
    ...
    "y91O": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
            ...
            function o(r, e) {
                ...
                return function() {
                    do {
                        ...
                        l *= l * l;
                        var i = 1 - t()
                    } while (i >= 1 - .0331 * r * r * r * r && Math.log(i) >= .5 * r * r + o * (1 - l + Math.log(l)));
                    return o * l * n() * e
                }
            }
            return o.source = r, o
    ...
    "g3J4": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "BDxe": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "Ani0": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        var u = function e(t) {
            function u(e, u, r) {
                var o;
                return 0 == (e = +e) ? o = (e => -Math.log(e)) : (e = 1 / e, o = (t => Math.pow(t, e))), u = null == u ? 0 : +u, r = null == r ? 1 : +r,
                    function() {
    ...
    "aFFQ": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        var u = function e(t) {
            function u(e, u) {
                return e = null == e ? 0 : +e, u = null == u ? 1 : +u,
                    function() {
    ...
    "LFPu": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "C4Uu": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
    ...
    "yOhd": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = o;
    ...
    "PPiB": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.Loess = void 0;
        var t = require("d3-selection"),
            e = require("d3-axis"),
            r = require("d3-scale"),
            a = require("d3-shape"),
            ...
            i = require("d3-ease"),
            n = require("d3-regression"),
            o = require("./meanSquaredError"),
            l = require("d3-random");
        ...
        var u = function() {
            function h(e) {
                c(this, h);
                this.loessContainer = e.loessContainer, this.barContainer = e.barContainer, this.sliderContainer = e.sliderContainer, this.bandwidth = .42, this.circleSize = 4.5, this.MARGIN = {
                    TOP: 30,
                    BOTTOM: 20,
                    LEFT: 35,
                    RIGHT: 10
                };
                var r = (0, t.select)("#".concat(this.loessContainer)).node().getBoundingClientRect();
                this.WIDTH = .8 * r.width, this.HEIGHT = window.innerWidth <= 600 ? .6 * r.height : .7 * r.height, this.addSlider(), this.drawLoess(), this.drawBars(), this.generateData(), this.drawLoessLine(this.bandwidth)
            }
            return d(h, [{
                key: "genData",
                value: function(t) {
                    var e = Array.from({
                        ...
                        return r = .029 * e, +(Math.round(r + "e+2") + "e-2");
                        var r
                    });
                    e = e.map(function(t) {
                        return t + Math.abs((0, l.randomNormal)(0, .05)())
                    }).sort(), !0 === t && (e[0] = .01, e[e.length - 1] = .99);
                    var r = e.map(function(t) {
                        return e = t, Math.sin(2.5 * Math.PI * e) / 1.5 + (0, l.randomNormal)(0, .25)();
                        var e
                    });
                ...
                value: function() {
                    var t = this;
                    this.loessG.selectAll("circle.loess-train").remove(), this.loessDataTrain = this.genData(!0), this.loessG.selectAll("circle.loess-train").data(this.loessDataTrain).enter().append("circle").attr("class", "loess-train").attr("r", this.circleSize).attr("cx", function(e) {
                        return t.xScale(+e.x)
                    }).attr("cy", function(e) {
                        return t.yScale(+e.y)
                ...
                value: function() {
                    var s = this;
                    this.loessG = this.initChartSvg(this.loessContainer), this.xScale = (0, r.scaleLinear)().domain([0, 1]).range([0, this.WIDTH]), this.yScale = (0, r.scaleLinear)().domain([-1.4, 1.4]).range([this.HEIGHT, 0]);
                    var i = (0, e.axisBottom)(this.xScale).ticks(4).tickSizeOuter(0),
                        n = (0, e.axisLeft)(this.yScale).tickSizeOuter(0).tickValues([0]);
                    this.lineGenerator = (0, a.line)().x(function(t) {
                        return s.xScale(t[0])
                    }).y(function(t) {
                        return s.yScale(t[1])
                    }), this.xAxis = this.loessG.append("g").attr("class", "axis").attr("id", "loess-x-axis").call(i).attr("transform", "translate(0, ".concat(this.HEIGHT, ")")), this.yAxis = this.loessG.append("g").attr("class", "axis").attr("id", "loess-y-axis").call(n), (0, t.select)("#loess-y-axis").select("line").attr("x2", this.WIDTH), (0, t.select)("#loess-y-axis").select("line").lower(), this.loessDataTest = this.genData(!1), this.loessG.selectAll("circle.loess-test").data(this.loessDataTest).enter().append("circle").attr("class", "loess-test").attr("r", this.circleSize).attr("cx", function(t) {
                        return s.xScale(+t.x)
                    }).attr("cy", function(t) {
                        return s.yScale(+t.y)
                    }), this.addLegend()
                ...
                key: "drawLoessLine",
                value: function(e) {
                    (0, t.select)("#bar-warning").remove(), (0, t.selectAll)("#loess-line").remove(), (0, t.selectAll)("circle.loess-t").remove(), this.regressionGenerator = (0, n.regressionLoess)().x(function(t) {
                        return t.x
                    }).y(function(t) {
                        return t.y
                    }).bandwidth(e);
                    var r = this.regressionGenerator(this.loessDataTrain);
                    this.loesPath = this.loessG.append("path").attr("id", "loess-line").datum(r).attr("d", this.lineGenerator), (0, t.select)("path#loess-line").lower();
                    var a = this.loessDataTrain.map(function(t) {
                            return t.y
                        }),
                        s = this.loessDataTest.map(function(t) {
                            return t.y
                        }),
                        i = r.map(function(t) {
                            return t[1]
                ...
                key: "addBarWarning",
                value: function() {
                    var t = this.barG.append("text").attr("id", "bar-warning").style("font-size", ".9rem").attr("x", 11.5).attr("y", 0);
                    t.append("tspan").text("Uh-oh! Sometimes our model doesn't fit the data."), t.append("tspan").text("Try again!").attr("x", 11.5).attr("dy", 15)
                }
            }, {
                key: "drawBars",
                value: function() {
                ...
                value: function() {
                    ...
                    var a = (0, t.select)("#".concat(this.loessContainer)).node().getBoundingClientRect();
                    this.WIDTH = .8 * a.width, (0, t.select)("#fit-container-loess-svg").transition().attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).select("#fit-container-loess-g"), (0, t.select)("#predict-container-loess-svg").transition().attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).select("#predict-container-loess-g"), this.xScaleError.range([0, this.WIDTH]), this.yScaleError.range([0, this.HEIGHT]), this.xScale.range([0, this.WIDTH]), this.yScale.range([this.HEIGHT, 0]), this.xAxisError.transition().call((0, e.axisBottom)(this.xScaleError).tickSizeOuter(0).ticks(4)), this.xAxis.transition().call((0, e.axisBottom)(this.xScale).ticks(4).tickSizeOuter(0)), this.rects.transition().duration(1e3).attr("width", function(t) {
                        return r.xScaleError(+t.error)
                    }), this.loessG.selectAll("circle.loess-train").transition().ease(i.easeBounceInOut).attr("cx", function(t) {
                        return r.xScale(+t.x)
                    }).attr("cy", function(t) {
                        return r.yScale(+t.y)
                    }), this.loessG.selectAll("circle.loess-test").transition().ease(i.easeExpInOut).attr("cx", function(t) {
                        return r.xScale(+t.x)
                    }).attr("cy", function(t) {
                        return r.yScale(+t.y)
                    }), this.drawLoessLine(this.bandwidth)
                ...
                value: function(t) {
                    var e = this;
                    (0, s.transition)().delay(500).duration(600);
                    this.rects = this.barG.selectAll("rect.loessBar").data(t, function(t) {
                        return t.name
                    }), this.rects.transition().duration(65).attr("x", function(t) {
                        return e.xScaleError(0)
                    }).attr("y", function(t) {
                        return e.yScaleError(t.name)
                    }).attr("width", function(t) {
                        return e.xScaleError(+t.error)
                    }).attr("height", this.yScaleError.bandwidth()), this.rects.enter().append("rect").attr("class", "loessBar").attr("x", function(t) {
                        return e.xScaleError(0)
                    }).attr("y", function(t) {
                        return e.yScaleError(t.name)
                    }).attr("height", this.yScaleError.bandwidth()).attr("width", function(t) {
                        return e.xScaleError(+t.error)
                    }).attr("fill", function(t) {
                        return e.loessBarColor(t.name)
                    })
                }
            }, {
                key: "addLegend",
                value: function() {
                    ...
                    a.append("text").style("font-size", "14px").attr("x", 11.5).attr("y", 10).text(function(t) {
                        return t
                    });
                    var s = 0;
                    a.attr("transform", function(t) {
                        var r = s;
                        return s += e(this) + 10, "translate(".concat(r, ", ", 0, ")")
                    }), r.attr("transform", function() {
                        return "translate(".concat((t.WIDTH - e(this)) / 2, ", ").concat(-t.MARGIN.TOP / 2, ")")
                    })
                }
            }, {
                key: "addSlider",
                ...
                key: "initChartSvg",
                value: function(e) {
                    return (0, t.select)("#".concat(e)).append("svg").attr("id", "".concat(e, "-svg")).attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).attr("height", this.HEIGHT + this.MARGIN.TOP + this.MARGIN.BOTTOM).append("g").attr("id", "".concat(e, "-g")).attr("transform", "translate(".concat(this.MARGIN.LEFT, ", ").concat(this.MARGIN.TOP, ")"))
                }
            }]), h
        }();
        exports.Loess = u;
    ...
    "pVbv": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.DoubleDescent = void 0;
        var t = require("d3-selection"),
            a = require("d3-axis"),
            e = require("d3-scale"),
            r = require("d3-shape"),
        ...
        function n(t, a, e) {
            return a && s(t.prototype, a), e && s(t, e), t
        }
        var h = function() {
            function s(a) {
                d(this, s), this.ddContainer = a.ddContainer, this.MARGIN = window.innerWidth <= 600 ? {
                    TOP: 30,
                    BOTTOM: 40,
                    LEFT: 20,
                    RIGHT: 35
                    ...
                    LEFT: 35,
                    RIGHT: 40
                }, this.WIDTH = window.innerWidth <= 600 ? .65 * window.innerWidth : .45 * window.innerWidth, this.HEIGHT = window.innerWidth <= 600 ? .3 * window.innerHeight : .35 * window.innerHeight, this.svg = (0, t.select)("#".concat(this.ddContainer)).append("svg").attr("id", "dd-svg").attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).attr("height", this.HEIGHT + this.MARGIN.TOP + this.MARGIN.BOTTOM).style("background-color", ""), this.ddG = this.svg.append("g").attr("id", "dd-g").attr("transform", "translate(".concat(this.MARGIN.LEFT, ", ").concat(this.MARGIN.TOP, ")")), this.ddG.append("clipPath").attr("id", "dd-clip").append("rect").attr("x", 0).attr("y", 10).attr("width", this.WIDTH + this.MARGIN.LEFT + this.MARGIN.RIGHT).attr("height", this.HEIGHT + this.MARGIN.TOP + this.MARGIN.BOTTOM), this.drawAxes(), this.drawDoubleDescentLines(), this.addAnnotations()
            }
            return n(s, [{
                key: "drawAxes",
                value: function() {
                    this.xScale = (0, e.scaleLinear)().domain([.5, 21]).range([0, this.WIDTH]), this.yScale = (0, e.scaleLinear)().domain([0, 34]).range([this.HEIGHT, 0]);
                ...
                value: function() {
                    var t = this,
                        a = (0, r.line)().x(function(a) {
                            return t.xScale(a.x)
                        }).curve(r.curveCatmullRom.alpha(.8));
                    ["train", "test"].map(function(e) {
                        a.y(function(a) {
                            return t.yScale(a["y_".concat(e)])
                        }), t.ddG.append("path").attr("class", "dd-line").attr("id", "dd-line-".concat(e)).attr("d", a(i.ddTrainTest))
                    }), a.y(function(a) {
                        return t.yScale(a.y_u)
                    }), this.ddG.append("path").attr("clip-path", "url(#dd-clip)").attr("class", "dd-line").attr("id", "dd-line-u").attr("d", a(i.ddUShape))
                }
            }, {
                key: "addTitle",
                value: function() {
                    this.svg.append("text").attr("id", "dd-title").attr("x", this.MARGIN.LEFT).attr("y", this.MARGIN.TOP / 1.5).attr("text-anchor", "left").text("The Double Descent Phenomena").style("font-weight", "bold")
                }
            }, {
                key: "addAnnotations",
                value: function() {
    ...
    "QvaY": [function(require, module, exports) {
        ...
        var e = a(require("scrollama")),
            r = require("./ErrorBar"),
            t = require("./annotations"),
            i = require("./Scatter"),
            n = require("./KNN"),
            o = require("./Loess"),
            l = require("./DoubleDescent"),
        ...
        (0, s.select)("#button-knn").on("click", function() {
            C.refreshChartWithNewData()
        });
        var b = new o.Loess({
        ...
        (0, s.select)("#button-loess").on("click", function() {
            b.generateData()
        });
        var y = new l.DoubleDescent({
            ddContainer: "dd-container"
        });

        function O() {
            var e = window.innerWidth <= 900 ? 1.8 : A,
                r = Math.floor(window.innerHeight * e);
            h.style("height", r + "px");
            var t = window.innerHeight / 1.1,
                i = window.innerWidth / 1.1,
                n = window.innerWidth / 2.4,
                o = .3 * window.innerHeight,
                l = (window.innerHeight - t) / 2;
            p.style("height", "".concat(t, "px")).style("width", "".concat(i, "px")).style("top", "".concat(l, "px")), B.attr("height", "".concat(o, "px")).attr("width", "".concat(n, "px")), x.attr("height", "".concat(o, "px")).attr("width", "".concat(n, "px")), b.resizeCharts(), g.resize()
        }
        var q = function() {
                (0, s.selectAll)("[id^='uf-preds']").remove(), (0, s.selectAll)("[id^='of-preds']").remove(), (0, s.selectAll)("[id^='good-preds']").remove()
            },
            z = {
                down: {
                    0: function() {
                    ...
                    1: function() {
                        T.drawTrainErrorUnderfit(), (0, s.select)("#errorBarSvg").selectAll(".axes").transition().delay(600).attr("visibility", "visible")
                    },
                    2: function() {
                        T.addLegend(), T.drawTestErrorOverfit(), setTimeout(function() {
                            t.a4.show(), t.a5.show()
                        }, 750)
                    },
                    3: function() {
                        [".errorLine", ".testErrorLine"].map(function(e) {
                            (0, s.selectAll)(e).remove()
                        }), T.drawLineOverfit(), T.drawBarsTrainOverfit()
                    },
                    4: function() {
                        T.drawBarsTestOverfit(), setTimeout(function() {
                            t.a3.show(), t.a6.show()
                        }, 750)
                    },
                    5: function() {
                        q(), (0, s.selectAll)(".errorLineComplex").remove(), T.plotTestBar(), (0, s.selectAll)("circle.test").transition().attr("r", 0), (0, s.select)("#regression-line-1").attr("visibility", "hidden"), (0, s.selectAll)(".legend").attr("visibility", "hidden"), setTimeout(function() {
                            t.a10.show()
                        }, 750)
                    },
                    6: function() {
                        q(), T.errorBar.addTitle(""), T.errorBar.positionErrorBarsAsLabels(), T.drawUnderfitRealizations(), T.errorBar.plotErrorLines("x", "uf"), setTimeout(function() {
                            t.a7.show()
                        }, 750)
                    },
                    7: function() {
                        q(), T.drawOverfitRealizations(), T.errorBar.plotErrorLines("x", "of"), setTimeout(function() {
                            t.a8.show()
                        }, 750)
                    },
                    8: function() {
                        q(), T.drawGoodRealizations(), T.errorBar.plotErrorLines("x", "good"), setTimeout(function() {
                            t.a9.show()
                        }, 750)
                    },
                    9: function() {
                        q(), T.errorBar.repositionSvgNew(), T.errorBar.plotErrorLines("x_point", "point"), T.errorBar.plotComplexCircleOne()
                    },
                    10: function() {
                        q(), T.errorBar.plotErrorLines("x", "final"), T.errorBar.plotComplexCircleAll(), setTimeout(function() {
                            t.a11.show()
                        }, 750)
                    }
                },
                up: {
                    0: function() {
                        q(), (0, s.selectAll)("rect.errorBar").transition().attr("width", 0), (0, s.selectAll)(".errorBar").transition().delay(500).remove(), (0, s.selectAll)(".errorLine").remove(), (0, s.select)("#errorBarSvg").selectAll(".axes").transition().delay(600).attr("visibility", "hidden"), (0, s.select)("#errorBarTitle").remove(), (0, s.selectAll)(".legend").remove()
                    },
                    1: function() {
                        q(), T.drawTrainErrorUnderfit(), (0, s.selectAll)(".testErrorLine").remove(), (0, s.selectAll)("circle.test").transition().attr("r", 0).transition().remove(), (0, s.selectAll)(".legend").remove()
                    },
                    2: function() {
                        q(), (0, s.selectAll)(".testErrorLine").remove(), (0, s.selectAll)(".errorLineComplex").remove(), T.drawLineUnderfit(), T.addLegend(), T.drawTestErrorOverfit()
                    },
                    3: function() {
                    ...
                    6: function() {
                        q(), T.drawUnderfitRealizations(), T.errorBar.plotErrorLines("x", "uf")
                    },
                    7: function() {
                        q(), T.drawOverfitRealizations(), T.errorBar.plotErrorLines("x", "of")
                    },
                    8: function() {
                        T.errorBar.upPositionSvg(), T.errorBar.plotErrorLines("x", "good"), (0, s.selectAll)("[class^='complex-']").transition().attr("r", 0).remove()
                    },
                    9: function() {
                        (0, s.selectAll)("[class^='complex-']").transition().attr("r", 0).remove(), T.errorBar.plotErrorLines("x_point", "point"), T.errorBar.plotComplexCircleOne()
                    },
                    10: function() {}
                }
            };
        ...
        function S(e) {
            z[e.direction][e.index]()
        }

        function k() {
            (0, s.selectAll)(".sticky").each(function() {
                Stickyfill.add(this)
            })
        }
        ...
        function D() {
            k(), O(), g.setup({
                ...
                offset: L
            }).onStepEnter(S), window.addEventListener("resize", O)
        }
        D();
    }, {
...
//# sourceMappingURL=js.63b32ab2.js.map