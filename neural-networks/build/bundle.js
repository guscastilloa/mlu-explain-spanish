    ...
    function ze(e) {
      ...
      return {
        c() {
          (n = M("section")),
            (n.innerHTML =
              '<h1 class="body-header">A Visual Introduction</h1> \n  <hr/> \n  <p class="body-text">Neural networks have revolutionized the field of artificial intelligence and\n    are the backbone of popular algorithms today, such as ChatGPT,\n    Stable-Diffusion, and many others. In this visual introduction, we&#39;ll\n    journey through the fundamentals of feed-forward neural networks, starting\n    from their essential components, understanding their learning mechanisms,\n    and even getting hands-on experience by interacting with one ourselves.</p> \n  <br/> \n  <h1 class="body-header">What Is A Network</h1> \n  <hr/> \n  <p class="body-text">Neural networks are networks - that much is clear. <i>But what is a &quot;network&quot;?</i>\n    A network is a structure consisting of interconnected computational nodes, or\n    &#39;neurons&#39;, arranged in layers. These nodes perform mathematical operations on\n    input data, learning some underlying patterns in the data, before producing some\n    output based on those patterns. If this sounds confusing, don&#39;t worry, we&#39;ll\n    make it clear soon enough.\n    <br/><br/>\n    To build up our intuition, we&#39;ll walk through constructing a basic computational\n    graph into a Neural Network:</p> \n  <br/> \n  <br/>');
        },
        m(t, e) {
          w(t, n, e);
        },
        ...
        (o = new Ai({})),
        {
          c() {
            (n = M("section")),
              ...
              (c = M("div")),
              (c.innerHTML =
                '<div class="step-content svelte-1yga2eg"><h2 class="svelte-1yga2eg">Building Blocks: Computational Graphs</h2> \n          <hr class="svelte-1yga2eg"/> \n          <br/> \n          <p class="svelte-1yga2eg">A computational graph has an input node where data is fed into the\n            graph, a function node where the input data is processed, and an\n            output node where the result of the computation is produced.\n            <br/><br/>\n            As we can see, data flows in one direction, from inputs to output, through\n            the graph.</p></div>'),
              (h = A()),
              (d = M("div")),
              (m = M("div")),
              (p = M("h2")),
              (p.textContent = "Linear Regression"),
              (f = A()),
              (g = M("hr")),
              (y = A()),
              (v = M("br")),
              ...
              ($ = M("p")),
              (S = z(
                "We can represent all sorts of algorithms with as computational\n            graphs. For example, we can easily represent ",
              )),
              (T = M("a")),
              (T.textContent = "Linear Regression"),
              ...
              (G = M("div")),
              (G.innerHTML =
                '<div class="step-content svelte-1yga2eg"><h2 class="svelte-1yga2eg">Model Outputs</h2> \n          <hr class="svelte-1yga2eg"/> \n          <br/> \n          <p class="svelte-1yga2eg">To make the process extra clear, let&#39;s visualize the outputs of our\n            linear regression model.\n            <br/><br/>\n            Just as we&#39;d expect, this model is outputting some predictions (the yellow\n            diagonal line) based on the input data.\n            <br/><br/>\n            As we build up a more complex model for different applications, we will\n            see this output change to reflect the state of the corresponding model.</p></div>'),
              (W = A()),
              (X = M("div")),
              (Y = M("div")),
              (Z = M("h2")),
              (Z.textContent = "Logistic Regression"),
              (K = A()),
              (J = M("hr")),
              (Q = A()),
              (tt = M("br")),
              ...
              (it = M("a")),
              (it.textContent = "logistic regression"),
              (at = z("?\n            ")),
              (ot = M("br")),
              (st = M("br")),
              (lt = z(
              ...
              B(
                R,
                "title",
                "Note - to map the exact equation above to the chart, one of the X terms should represent the bias term: 1.",
              ),
              (j.a = V),
          ...
          c() {
            (n = M("section")),
              ...
              B(
                y,
                "title",
                "In fact, the Universal Approximation Theorem essentially says that a properly structured and configured neural network is theoretically capable of modeling any complex relationship, but practically, it can be challenging to find the right parameters to achieve this.",
              ),
              B(d, "class", "body-text"),
              B(H, "class", "body-text"),
    ...
    function Ji(e) {
      ...
      return {
        c() {
          (n = M("section")),
            (n.innerHTML =
              '<br/> \n  <h3 class="body-header">Thanks For Reading</h3> \n  <hr/> \n  <p class="body-text">Thanks for reading! We hope that the article is insightful no matter where\n    you are along your machine learning journey, and that you came away with a\n    better understanding of Neural Networks.\n    <br/><br/>\n    To learn more about machine learning, check out our\n    <a class="on-end svelte-5b0mv7" href="https://aws.amazon.com/machine-learning/mlu/">self-paced courses</a>, our\n    <a class="on-end svelte-5b0mv7" href="https://www.youtube.com/channel/UC12LqyqTQYbXatYS9AA7Nuw">YouTube videos</a>, and the\n    <a class="on-end svelte-5b0mv7" href="https://d2l.ai/">Dive into Deep Learning</a>\n    textbook. If you have any comments or ideas related to\n    <a class="on-end svelte-5b0mv7" href="https://mlu-explain.github.io/">MLU-Explain articles</a>, feel free to reach out\n    <a class="on-end svelte-5b0mv7" href="https://twitter.com/jdwlbr">directly</a>. The code\n    for this article is available\n    <a class="on-end svelte-5b0mv7" href="https://github.com/aws-samples/aws-mlu-explain">here</a>.\n    <br/><br/>\n    Go forth and learn!</p> \n\n  <br/><br/> \n  <br/><br/>');
        },
        m(t, e) {
          w(t, n, e);
        },
        ...
        (b = new Ea({})),
        {
          c() {
            (n = M("div")),
              ...
              (H = A()),
              (D = M("button")),
              (D.textContent = "Replay Animation"),
              (F = A()),
              (j = M("div")),
              (V = M("div")),
              (U = M("h2")),
              ...
              (tt = A()),
              (et = M("button")),
              (et.textContent = "Replay Animation"),
              (nt = A()),
              (rt = M("div")),
              (it = M("div")),
              (at = M("h2")),
              (at.textContent = "Backward Pass"),
              (ot = A()),
              (st = M("hr")),
              (lt = A()),
              (ct = M("br")),
              ...
              (gt = A()),
              (yt = M("button")),
              (yt.textContent = "Replay Animation"),
              (wt = A()),
              (kt = M("div")),
              ($t = M("div")),
              (Mt = M("h2")),
              (Mt.textContent = "BackPropagation"),
              (St = A()),
              (zt = M("hr")),
              (At = A()),
              (Tt = M("br")),
    ...
    function ss(e) {
      ...
      return {
        c() {
          (n = M("section")),
            (r = M("h3")),
            (r.textContent = "Going Forward: Other Neural Network Architectures"),
            (i = A()),
            (o = M("hr")),
            (s = A()),
            (l = M("p")),
            ...
            (h = M("span")),
            (h.textContent = "feed forward neural networks"),
            (d = z(", or\n    ")),
            (m = M("span")),
            (m.textContent = "artificial neural networks"),
            (p = z(" (ANN's\n    ")),
            (f = M("sup")),
            (g = M("span")),
            (g.textContent = "[ℹ]\n      "),
            ...
            B(
              g,
              "title",
              "The word 'artificial' comes\n      from the network's composition of artificial neurons.",
            ),
            B(b, "class", "info-tooltip"),
            B(
              b,
              "title",
              "Indeed, this notion of a network of step-functions 'firing' or not is deeply inspired by the workings of biological neurons in the human brain, thus giving rise to the brain-like analogy often used to describe neural networks.",
            ),
            B(l, "class", "body-text"),
            B(C, "class", "body-text"),
